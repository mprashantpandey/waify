            ...
            <Card>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Slack</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <InputLabel htmlFor="integrations.slack_webhook_url" value="Webhook URL" />
                                <TextInput
                                ...
                                />
                                <InputError message={errors['integrations.slack_webhook_url']} />
                            </div>
                            <div className="flex items-center justify-between">
                                <div>
                                    <InputLabel value="Enable Slack" />
                    ...
                    {/* Discord */}
                    <div>
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Discord</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <InputLabel htmlFor="integrations.discord_webhook_url" value="Webhook URL" />
                                <TextInput
                                ...
                                />
                                <InputError message={errors['integrations.discord_webhook_url']} />
                            </div>
                            <div className="flex items-center justify-between">
                                <div>
                                    <InputLabel value="Enable Discord" />
                                    <p className="text-sm text-gray-500 dark:text-gray-400">Send notifications to Discord</p>
                                </div>
                                <label className="relative inline-flex items-center cursor-pointer">
                                    <input
                                        type="checkbox"
