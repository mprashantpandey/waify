...
import { Check, ArrowRight, Zap, Users, Building2, Crown, X, Mail, Sparkles, ChevronDown, ChevronUp, Star, ShieldCheck, CreditCard, RefreshCcw } from 'lucide-react';
        ...
        <PublicLayout>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
                <PublicPageHero
                    ...
                    title="Flexible pricing for every growth stage"
                    description="Pick a plan that matches your volume and support needs. Upgrade anytime as your WhatsApp operations scale."
                    actions={
                ...
                <div className="mb-12 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="rounded-xl border border-blue-200 dark:border-blue-900 bg-blue-50/80 dark:bg-blue-900/20 p-4 text-sm text-blue-900 dark:text-blue-100">
                        <span className="font-semibold">No lock-in:</span> switch plans or cancel anytime.
                    </div>
                    <div className="rounded-xl border border-purple-200 dark:border-purple-900 bg-purple-50/80 dark:bg-purple-900/20 p-4 text-sm text-purple-900 dark:text-purple-100">
                        <span className="font-semibold">Transparent billing:</span> clear feature and usage visibility.
                    </div>
                    <div className="rounded-xl border border-emerald-200 dark:border-emerald-900 bg-emerald-50/80 dark:bg-emerald-900/20 p-4 text-sm text-emerald-900 dark:text-emerald-100">
                        <span className="font-semibold">Guided onboarding:</span> support to launch faster.
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-12 sm:mb-16">
                    <div className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-6 text-center border border-blue-200 dark:border-blue-800">
                        <div className="inline-flex items-center justify-center rounded-xl bg-white/90 dark:bg-gray-900/40 p-3 mb-3">
                    ...
                    <div className="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl p-6 text-center border border-purple-200 dark:border-purple-800">
                        <div className="inline-flex items-center justify-center rounded-xl bg-white/90 dark:bg-gray-900/40 p-3 mb-3">
                            <RefreshCcw className="h-6 w-6 text-purple-600 dark:text-purple-300" />
                        </div>
