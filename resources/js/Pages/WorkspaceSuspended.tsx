                ...
                <Card className="w-full max-w-md border-0 shadow-2xl">
                    <CardContent className="pt-12 pb-8 text-center">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6">
                            The workspace <strong className="text-gray-900 dark:text-gray-100">{workspace.name}</strong> has been disabled.
                        </p>
                        {workspace.disabled_reason && (
                            <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-xl p-4 mb-6 text-left">
                                <p className="text-sm text-yellow-800 dark:text-yellow-200">
                                    <strong>Reason:</strong> {workspace.disabled_reason}
                                </p>
                            </div>
                        )}
