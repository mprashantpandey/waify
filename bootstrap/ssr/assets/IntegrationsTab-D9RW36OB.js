...
import { Key, EyeOff, Eye, Link, Webhook, MessageCircle } from "lucide-react";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { value: "Queue Failure Alerts" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400", children: "Send immediate email/webhook alerts when a queued job fails." })
          ] }),
          /* @__PURE__ */ jsxs("label", { className: "relative inline-flex items-center cursor-pointer", children: [
            /* @__PURE__ */ jsx(
              "input",
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "alerts.email_to", value: "Alert Email" }),
            /* @__PURE__ */ jsx(
              TextInput,
              {
                id: "alerts.email_to",
            ...
            /* @__PURE__ */ jsx(InputError, { message: errors["alerts.email_to"] })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "alerts.dedupe_minutes", value: "Dedupe Window (minutes)" }),
            /* @__PURE__ */ jsx(
              TextInput,
              {
            ...
            /* @__PURE__ */ jsx(InputError, { message: errors["alerts.dedupe_minutes"] })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "alerts.webhook_url", value: "Alert Webhook URL" }),
            /* @__PURE__ */ jsx(
              TextInput,
              {
            ...
            /* @__PURE__ */ jsx(InputError, { message: errors["alerts.webhook_url"] })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "alerts.slack_webhook_url", value: "Slack Webhook URL" }),
            /* @__PURE__ */ jsx(
              TextInput,
              {
            ...
            /* @__PURE__ */ jsx(InputError, { message: errors["alerts.slack_webhook_url"] })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "pt-2 border-t border-gray-200 dark:border-gray-800 space-y-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(InputLabel, { value: "High Error Rate Alerts (WhatsApp)" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400", children: "Email tenant owner/admin when outbound WhatsApp failure rate crosses threshold." })
            ] }),
            /* @__PURE__ */ jsxs("label", { className: "relative inline-flex items-center cursor-pointer", children: [
              /* @__PURE__ */ jsx(
                "input",
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "integrations.whatsapp_error_rate_threshold_percent", value: "Failure Threshold (%)" }),
              /* @__PURE__ */ jsx(
                TextInput,
                {
              ...
              /* @__PURE__ */ jsx(InputError, { message: errors["integrations.whatsapp_error_rate_threshold_percent"] })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "integrations.whatsapp_error_rate_window_minutes", value: "Window (minutes)" }),
              /* @__PURE__ */ jsx(
                TextInput,
                {
              ...
              /* @__PURE__ */ jsx(InputError, { message: errors["integrations.whatsapp_error_rate_window_minutes"] })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "integrations.whatsapp_error_rate_minimum_messages", value: "Min Outbound Messages" }),
              /* @__PURE__ */ jsx(
                TextInput,
                {
              ...
              /* @__PURE__ */ jsx(InputError, { message: errors["integrations.whatsapp_error_rate_minimum_messages"] })
            ] })
          ] })
        ] })
      ] })
    ...
    /* @__PURE__ */ jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "whatsapp.system_user_id", value: "System User ID" }),
            /* @__PURE__ */ jsx(
              TextInput,
              {
            ...
            /* @__PURE__ */ jsx(InputError, { message: errors["whatsapp.system_user_id"] })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "whatsapp.partner_business_id", value: "Partner Business ID" }),
            /* @__PURE__ */ jsx(
              TextInput,
              {
            ...
            /* @__PURE__ */ jsx(InputError, { message: errors["whatsapp.partner_business_id"] })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "whatsapp.credit_line_id", value: "Credit Line ID" }),
            /* @__PURE__ */ jsx(
              TextInput,
              {
            ...
            /* @__PURE__ */ jsx(InputError, { message: errors["whatsapp.credit_line_id"] })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "whatsapp.template_api_mode", value: "Template API Mode" }),
            /* @__PURE__ */ jsxs(
              "select",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("option", { value: "direct", children: "Direct (WABA endpoint)" }),
                  /* @__PURE__ */ jsx("option", { value: "obo", children: "On-Behalf-Of (Partner endpoint)" })
                ]
              }
            ),
            /* @__PURE__ */ jsx(InputError, { message: errors["whatsapp.template_api_mode"] })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between rounded-lg border border-gray-200 dark:border-gray-800 p-3", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { value: "Strict Embedded Provisioning" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400", children: "If enabled, embedded signup will fail when System User assignment or credit-line attachment fails." })
          ] }),
          /* @__PURE__ */ jsxs("label", { className: "relative inline-flex items-center cursor-pointer", children: [
            /* @__PURE__ */ jsx(
              "input",
