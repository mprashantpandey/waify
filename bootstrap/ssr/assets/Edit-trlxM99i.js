...
function ListsEdit({
  ...
  const submit = (e) => {
    ...
    put(route("app.whatsapp.lists.update", { list: list.id }), {
      ...
      onError: (errors2) => {
        toast.error("Failed to update list", Object.values(errors2).flat().join(", "));
      }
    });
  };
  const addSection = () => {
  ...
  return /* @__PURE__ */ jsxs(AppShell, { children: [
    /* @__PURE__ */ jsx(Head, { title: `Edit List: ${list.name}` }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsx(Link, { href: route("app.whatsapp.lists.show", { list: list.id }), children: /* @__PURE__ */ jsxs(Button, { variant: "ghost", size: "sm", children: [
          /* @__PURE__ */ jsx(ArrowLeft, { className: "h-4 w-4 mr-2" }),
          "Back"
        ] }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-gray-900 dark:text-gray-100", children: "Edit List" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-gray-500 dark:text-gray-400", children: "Update your interactive list message" })
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-4", children: [
          /* @__PURE__ */ jsx(Link, { href: route("app.whatsapp.lists.show", { list: list.id }), children: /* @__PURE__ */ jsx(Button, { type: "button", variant: "secondary", children: "Cancel" }) }),
          /* @__PURE__ */ jsx(Button, { type: "submit", disabled: processing, children: processing ? "Updating..." : "Update List" })
        ] })
      ] })
    ] })
  ] });
