...
import { CheckCircle2, ShieldAlert, Bell, ExternalLink } from "lucide-react";
import "react";
import "axios";
...
function PlatformNotificationsIndex({ notifications, stats }) {
  const { auth } = usePage().props;
  const markRead = (notification) => router.post(route("platform.notifications.read", notification.id), {}, { preserveScroll: true });
  ...
  return /* @__PURE__ */ jsxs(PlatformShell, { auth, children: [
    /* @__PURE__ */ jsx(Head, { title: "Platform Notifications" }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-waify-text dark:text-waify-dark-text", children: "Platform notifications" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-waify-text-muted dark:text-waify-dark-text-muted", children: "Failed webhooks, failed payments, automation failures, and WABA health alerts." })
        ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 gap-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsx(Badge, { variant: notification.severity === "critical" ? "danger" : notification.severity === "warning" ? "warning" : "info", children: notification.severity }),
            ...
            /* @__PURE__ */ jsxs("p", { className: "mt-2 text-xs text-waify-text-muted dark:text-waify-dark-text-muted", children: [
              notification.account?.name ? `${notification.account.name} · ` : "",
...
export {
  PlatformNotificationsIndex as default
};
