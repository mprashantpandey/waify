    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-gray-900 dark:text-gray-100", children: "Widgets" }),
          /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-gray-600 dark:text-gray-400", children: "Create Floater, Banner, Link, or QR widgets for customer conversations." })
        ] }),
        /* @__PURE__ */ jsx(Link, { href: route("app.widgets.create", {}), children: /* @__PURE__ */ jsxs(Button, { className: "bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 shadow-lg shadow-emerald-500/40", children: [
      ...
      widgets.length === 0 ? /* @__PURE__ */ jsx(Card, { className: "border-0 shadow-xl", children: /* @__PURE__ */ jsxs(CardContent, { className: "py-14 text-center", children: [
        ...
        /* @__PURE__ */ jsx(Link, { href: route("app.widgets.create", {}), className: "inline-flex mt-6", children: /* @__PURE__ */ jsx(Button, { className: "bg-emerald-600 hover:bg-emerald-700 text-white", children: "Create Widget" }) })
        ...
        /* @__PURE__ */ jsx(CardHeader, { className: "border-b border-gray-100 dark:border-gray-800", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "mt-1 text-xs text-gray-500 uppercase tracking-wide", children: widget.widget_type })
          ] }),
        ...
        /* @__PURE__ */ jsxs(CardContent, { className: "p-6 space-y-4", children: [
          ...
          widget.widget_type === "floater" || widget.widget_type === "banner" ? /* @__PURE__ */ jsxs("div", { className: "rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-3 text-xs text-gray-500", children: [
            "Embed: ",
          ...
          ] }) : /* @__PURE__ */ jsx("div", { className: "rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 p-3 text-xs text-blue-700 dark:text-blue-300", children: "Share type widget: use link/QR from Manage page." }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
            /* @__PURE__ */ jsx(Link, { href: route("app.widgets.edit", { widget: widget.slug || widget.id }), children: /* @__PURE__ */ jsx(Button, { variant: "secondary", children: "Manage" }) }),
            (widget.widget_type === "floater" || widget.widget_type === "banner") && /* @__PURE__ */ jsx(
              Button,
              {
                variant: "secondary",
