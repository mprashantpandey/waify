      ...
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-stretch sm:items-center gap-2", children: [
            ...
            campaign.status === "draft" && /* @__PURE__ */ jsxs(Button, { onClick: handleStart, className: "w-full sm:w-auto bg-blue-600 hover:bg-blue-700", children: [
              /* @__PURE__ */ jsx(Play, { className: "h-4 w-4 mr-2" }),
              "Start"
            ] }),
            campaign.status === "sending" && /* @__PURE__ */ jsxs(Button, { onClick: handlePause, variant: "secondary", className: "w-full sm:w-auto", children: [
              /* @__PURE__ */ jsx(Pause, { className: "h-4 w-4 mr-2" }),
              "Pause"
            ] }),
            campaign.status === "paused" && /* @__PURE__ */ jsxs(Button, { onClick: handleStart, className: "w-full sm:w-auto bg-blue-600 hover:bg-blue-700", children: [
              /* @__PURE__ */ jsx(Play, { className: "h-4 w-4 mr-2" }),
              "Resume"
            ] }),
            ["draft", "scheduled", "sending", "paused"].includes(campaign.status) && /* @__PURE__ */ jsxs(Button, { onClick: handleCancel, variant: "secondary", className: "w-full sm:w-auto text-red-600 hover:text-red-700", children: [
              /* @__PURE__ */ jsx(X, { className: "h-4 w-4 mr-2" }),
              "Cancel"
            ] }),
            stats.failed > 0 && /* @__PURE__ */ jsx(Button, { onClick: handleRetryFailed, variant: "secondary", className: "w-full sm:w-auto", children: "Retry Failed" }),
            /* @__PURE__ */ jsx(Button, { onClick: handleDuplicate, variant: "secondary", className: "w-full sm:w-auto", children: "Duplicate" }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto", children: [
              /* @__PURE__ */ jsx(
                "input",
                {
                  value: testPhone,
              ...
              /* @__PURE__ */ jsx(Button, { onClick: handleSendTest, variant: "secondary", className: "w-full sm:w-auto", children: "Send Test To Me" })
            ] }),
            ["draft", "cancelled", "completed"].includes(campaign.status) && /* @__PURE__ */ jsx(Button, { onClick: handleDelete, variant: "secondary", className: "w-full sm:w-auto text-red-600 hover:text-red-700", children: "Delete" })
          ] })
        ] })
      ] }),
