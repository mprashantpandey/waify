...
function BillingPlans({
  ...
  const handleSwitchPlan = async (planKey) => {
    ...
    const confirmed = await confirm({
      ...
      message: isNewPlan ? `Are you sure you want to select the ${plan?.name ?? "this"} plan?` : "Are you sure you want to switch to this plan?",
      variant: "info"
    });
    if (!confirmed) return;
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
      hasNoPlan && /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-700 dark:text-gray-300 mb-4", children: "Your account doesn't have an active plan. Please select a plan below to continue using the platform. You can start with our free plan or choose a paid plan." })
        ] })
      ] }) }),
              ...
              (() => {
                ...
                return /* @__PURE__ */ jsx(
                  Button,
                  {
                    ...
                    children: canPayCurrent ? "Pay to Renew" : plan.is_current ? "Current Plan" : switchingPlan === plan.key ? "Switching..." : plan.price_monthly === null ? "Contact Sales" : plan.price_monthly > 0 && razorpayEnabled ? "Pay & Switch" : "Switch to this Plan"
                  }
                );
              })()
            ] })
