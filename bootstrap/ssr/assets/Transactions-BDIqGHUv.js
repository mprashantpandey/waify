...
function BillingTransactions({
  ...
  return /* @__PURE__ */ jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
          /* @__PURE__ */ jsx("thead", { className: "bg-gray-50 dark:bg-gray-900", children: /* @__PURE__ */ jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-left", children: "Details" })
          ] }) }),
          /* @__PURE__ */ jsxs("tbody", { children: [
            transactions.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 8, className: "px-4 py-6 text-center text-gray-500", children: "No transactions found." }) }),
            transactions.map((tx, idx) => /* @__PURE__ */ jsxs("tr", { className: "border-t border-gray-200 dark:border-gray-800", children: [
              ...
              /* @__PURE__ */ jsx("td", { className: "px-4 py-3", children: sourceLabel(tx.source) }),
      ...
      selectedTx && /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Transaction Details" }) }),
        /* @__PURE__ */ jsxs(CardContent, { className: "space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxs("p", { children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Type:" }),
            " ",
            selectedTx.type
          ] }),
          /* @__PURE__ */ jsxs("p", { children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Direction:" }),
            " ",
            selectedTx.direction
          ] }),
          /* @__PURE__ */ jsxs("p", { children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Amount:" }),
            " ",
            formatMoney(selectedTx.amount_minor, selectedTx.currency)
          ] }),
          /* @__PURE__ */ jsxs("p", { children: [
          ...
          /* @__PURE__ */ jsxs("p", { children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Source:" }),
            " ",
            sourceLabel(selectedTx.source)
          ] }),
          /* @__PURE__ */ jsxs("p", { children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Reference:" }),
            " ",
            /* @__PURE__ */ jsx("span", { className: "font-mono", children: selectedTx.reference || "N/A" })
          ] }),
          /* @__PURE__ */ jsxs("p", { children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Notes:" }),
            " ",
            selectedTx.notes || "N/A"
          ] }),
          /* @__PURE__ */ jsxs("p", { children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Created:" }),
            " ",
            new Date(selectedTx.created_at).toLocaleString()
          ] }),
          /* @__PURE__ */ jsx("div", { className: "pt-2", children: /* @__PURE__ */ jsx(Button, { variant: "secondary", size: "sm", onClick: () => setSelectedTx(null), children: "Close" }) })
        ] })
      ] })
    ] })
  ] });
