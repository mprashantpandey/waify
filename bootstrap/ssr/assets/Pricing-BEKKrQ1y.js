...
function Pricing({ plans, canRegister }) {
  ...
  return /* @__PURE__ */ jsxs(PublicLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-12 sm:mb-16", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-200 dark:border-gray-800", children: [
