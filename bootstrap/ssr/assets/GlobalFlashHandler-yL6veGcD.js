...
import { u as useToast, h as hasRecentNonFlashToast } from "./useToast-CwsXrmjR.js";
...
function GlobalFlashHandler() {
  ...
  useEffect(() => {
    ...
    const emittedSemantic = /* @__PURE__ */ new Set();
    const normalize = (value) => value.trim().toLowerCase().replace(/\b(successfully|successful|success)\b/g, "").replace(/\b(done|completed)\b/g, "").replace(/[.!?]+$/g, "").replace(/\s+/g, " ").trim();
