    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, children: [
        ...
        /* @__PURE__ */ jsxs(Card, { className: "mt-6", children: [
          ...
          /* @__PURE__ */ jsx(CardContent, { className: "space-y-4", children: data.filters.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400", children: "No filters. Add a rule to limit which contacts are in this segment." }) : data.filters.map((filter, index) => /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-[10rem_9rem_minmax(0,1fr)_auto] items-end gap-2 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-6 flex flex-col-reverse sm:flex-row gap-3 sm:gap-4", children: [
          /* @__PURE__ */ jsx(Button, { type: "submit", className: "w-full sm:w-auto", disabled: processing, children: "Save changes" }),
          /* @__PURE__ */ jsx(Link, { href: route("app.contacts.segments.show", { segment: segment.id }), className: "w-full sm:w-auto", children: /* @__PURE__ */ jsx(Button, { type: "button", variant: "secondary", className: "w-full sm:w-auto", children: "Cancel" }) })
        ] })
      ] })
    ] })
  ] });
