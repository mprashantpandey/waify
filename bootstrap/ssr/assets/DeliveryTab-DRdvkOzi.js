...
import { Activity, ServerCog, Mail, MessageSquare, Radio, AlertTriangle } from "lucide-react";
...
function DeliveryTab({ delivery }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    delivery.recent_failures.length > 0 && /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsxs(CardHeader, { children: [
      ...
      /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("div", { className: "space-y-2", children: delivery.recent_failures.map((failure) => /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-red-200 bg-red-50 p-3 text-sm dark:border-red-900/40 dark:bg-red-900/20", children: [
    ...
    delivery.mail.recent_outbox_failures.length > 0 && /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsxs(CardHeader, { children: [
      ...
      /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("div", { className: "space-y-2", children: delivery.mail.recent_outbox_failures.map((failure, idx) => /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-amber-200 bg-amber-50 p-3 text-sm dark:border-amber-900/40 dark:bg-amber-900/20", children: [
        /* @__PURE__ */ jsxs("div", { className: "mb-1 flex items-center justify-between gap-3", children: [
