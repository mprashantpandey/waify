...
export default function TemplatesEdit({
    ...
    const calculateVariableCount = (text: string) => {
    ...
    // Initialize variable count on mount
    useEffect(() => {
                                ...
                                <CardContent className="space-y-4 pt-6">
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                            Connection cannot be changed when editing
                                        </p>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <Select
                                                value={data.language}
                                                onValueChange={(value: string) => setData('language', value)}
                                            >
                                                <SelectTrigger>
                                                    <SelectValue>
                                                        {LANGUAGE_CODES.find(l => l.code === data.language)?.name || 'Select language'}
                                                    </SelectValue>
                                                </SelectTrigger>
                                                <SelectContent>
                                ...
                                <CardContent className="space-y-4 pt-6">
                                    <div>
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(value: any) => setData('header_type', value)}
                                        >
                                            <SelectTrigger>
                                                <SelectValue>
                                ...
                                <CardContent className="space-y-4 pt-6">
                                    ...
                                    {variableCount > 0 && (
                                        <div>
                                            ...
                                            <div className="space-y-2">
                                                {Array.from({ length: variableCount }, (_, i) => i + 1).map((varNum: number) => (
