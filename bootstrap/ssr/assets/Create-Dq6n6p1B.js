...
import { ArrowLeft, AlertCircle, Sparkles, Info, XCircle, CheckCircle2, FileText, Upload, Image, Video, File, X, Plus, Trash2 } from "lucide-react";
...
function TemplatesCreate({
  ...
  const approvalChecklist = useMemo(() => {
    ...
    const variableSequenceValid = bodyVariables.length === 0 || bodyVariables.every((value, index) => value === index + 1);
    ...
    return [
      ...
      { label: "Variables are sequential ({{1}}, {{2}}...)", ok: variableSequenceValid },
      {
        ...
        ok: !["IMAGE", "VIDEO", "DOCUMENT"].includes(data.header_type) || Boolean((data.header_media_url || "").trim())
      },
  ...
  return /* @__PURE__ */ jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
      ...
      errors.create && /* @__PURE__ */ jsxs(Alert, { variant: "error", className: "border-red-200 dark:border-red-800", children: [
        /* @__PURE__ */ jsx(XCircle, { className: "h-5 w-5" }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "font-semibold text-red-800 dark:text-red-200 mb-1", children: "Template Create Error" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-red-600 dark:text-red-400", children: errors.create })
        ] })
      ] }),
      /* @__PURE__ */ jsxs(Card, { className: "border-0 shadow-lg", children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsx(CardTitle, { children: "Local Approval Checklist" }),
          /* @__PURE__ */ jsx(CardDescription, { children: "Preflight checks before submitting to Meta" })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { className: "space-y-2", children: approvalChecklist.map((item, index) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-sm", children: [
          /* @__PURE__ */ jsx("span", { children: item.label }),
          item.ok ? /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 text-emerald-600", children: [
            /* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4" }),
            " OK"
          ] }) : /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 text-amber-600", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-between gap-3 pt-6", children: [
          /* @__PURE__ */ jsx(
            Link,
            {
              href: route("app.whatsapp.templates.index", {}),
              className: "w-full sm:w-auto",
              children: /* @__PURE__ */ jsx(Button, { variant: "secondary", className: "w-full sm:w-auto", children: "Cancel" })
            }
          ),
          /* @__PURE__ */ jsx(
            Button,
            {
              ...
              children: submitting || processing ? "Creating..." : uploadingMedia ? "Waiting for upload..." : "Create Template"
            }
          )
        ] })
      ] })
