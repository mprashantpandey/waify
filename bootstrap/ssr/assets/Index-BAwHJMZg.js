  ...
  return /* @__PURE__ */ jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "h-[calc(100vh-8rem)] lg:h-[calc(100vh-6rem)]", children: /* @__PURE__ */ jsxs("div", { className: "grid h-full lg:grid-cols-[360px_1fr] rounded-3xl overflow-hidden border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-xl", children: [
      /* @__PURE__ */ jsxs("section", { className: "flex flex-col border-r border-gray-200 dark:border-gray-800", children: [
        /* @__PURE__ */ jsx("div", { className: "px-5 py-4 bg-[#075E54] text-white", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex shrink-0 items-center gap-2 text-xs self-start sm:self-auto", children: connected ? /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-white/15 px-2 py-1", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "px-4 py-3 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-3 grid grid-cols-1 sm:grid-cols-2 gap-2", children: [
            /* @__PURE__ */ jsxs(
              "select",
              {
                value: statusFilter,
