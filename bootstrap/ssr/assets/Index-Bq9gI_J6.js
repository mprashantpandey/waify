...
import { Plus, Bot, Zap, Activity, AlertCircle, Edit } from "lucide-react";
import "react";
  ...
  return /* @__PURE__ */ jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsx(Link, { href: route("app.chatbots.create", { workspace: workspace.slug }), children: /* @__PURE__ */ jsxs(Button, { className: "bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 shadow-lg shadow-purple-500/50", children: [
      ...
      bots.length === 0 ? /* @__PURE__ */ jsx(Card, { className: "border-0 shadow-xl", children: /* @__PURE__ */ jsxs(CardContent, { className: "py-16 text-center", children: [
        ...
        /* @__PURE__ */ jsxs(CardContent, { className: "p-6 space-y-4", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2 pt-4 border-t border-gray-200 dark:border-gray-700", children: /* @__PURE__ */ jsx(
            Link,
            {
