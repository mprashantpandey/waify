  ...
  return /* @__PURE__ */ jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(InputLabel, { htmlFor: "mail.support_ticket_email_cooldown_minutes", value: "Support Ticket Email Cooldown (minutes)" }),
          /* @__PURE__ */ jsx(
            TextInput,
            {
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-gray-500 dark:text-gray-400", children: "Prevents repeated support ticket emails for the same ticket/direction within this cooldown window." }),
          /* @__PURE__ */ jsx(InputError, { message: errors["mail.support_ticket_email_cooldown_minutes"] })
        ] })
      ] }),
