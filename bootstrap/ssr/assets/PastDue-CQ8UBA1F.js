...
function BillingPastDue({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 flex items-center justify-center p-4", children: /* @__PURE__ */ jsx(Card, { className: "w-full max-w-md border-0 shadow-2xl", children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-12 pb-8 text-center", children: [
      ...
      /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-gray-100 dark:to-gray-300 bg-clip-text text-transparent mb-3", children: "Renewal Needed" }),
      ...
      /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400 mb-6", children: "Complete renewal to restore full access immediately." }),
      /* @__PURE__ */ jsx(Link, { href: route("app.billing.index", {}), children: /* @__PURE__ */ jsx(Button, { className: "bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 shadow-lg shadow-blue-500/50 rounded-xl w-full", children: "Open Billing & Renew" }) })
    ] }) }) })
  ] });
}
export {
