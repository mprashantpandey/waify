...
function DeliveryTab({ delivery, data, setData, errors }) {
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-4 lg:grid-cols-2", children: [
      ...
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          ...
          /* @__PURE__ */ jsx(CardDescription, { children: "Auto-pause campaigns when queue backlog or failed jobs spike." })
        ] }),
        /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "campaigns.queue_pending_threshold", value: "Pending Jobs Threshold" }),
            /* @__PURE__ */ jsx(
              TextInput,
              {
                ...
                min: "100",
                max: "200000",
                value: data.campaigns?.queue_pending_threshold ?? 3e3,
                onChange: (e) => setData(
            ...
            /* @__PURE__ */ jsxs("p", { className: "mt-1 text-xs text-slate-500 dark:text-slate-400", children: [
              ...
              delivery.queue.pending_total
            ] }),
            /* @__PURE__ */ jsx(InputError, { message: errors["campaigns.queue_pending_threshold"] })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "campaigns.failed_jobs_threshold", value: "Failed Jobs Threshold" }),
            /* @__PURE__ */ jsx(
              TextInput,
              {
            ...
            /* @__PURE__ */ jsx(InputError, { message: errors["campaigns.failed_jobs_threshold"] })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "campaigns.failed_jobs_window_minutes", value: "Failed Jobs Time Window (Minutes)" }),
            /* @__PURE__ */ jsx(
              TextInput,
              {
            ...
            /* @__PURE__ */ jsx(InputError, { message: errors["campaigns.failed_jobs_window_minutes"] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs(Card, { children: [
