    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-4 mt-2 text-sm text-gray-500 dark:text-gray-400", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-stretch sm:items-center gap-2 lg:shrink-0", children: [
            /* @__PURE__ */ jsxs(Button, { variant: "secondary", size: "sm", className: "w-full sm:w-auto", onClick: handleRecalculate, children: [
              /* @__PURE__ */ jsx(RefreshCw, { className: "h-4 w-4 mr-2" }),
              "Recalculate"
            ] }),
            /* @__PURE__ */ jsx(Link, { href: route("app.contacts.segments.edit", { segment: segment.id }), className: "w-full sm:w-auto", children: /* @__PURE__ */ jsxs(Button, { variant: "secondary", size: "sm", className: "w-full sm:w-auto", children: [
              /* @__PURE__ */ jsx(Pencil, { className: "h-4 w-4 mr-2" }),
              "Edit"
            ] }) }),
            /* @__PURE__ */ jsxs(Button, { variant: "secondary", size: "sm", className: "w-full sm:w-auto", onClick: handleDelete, children: [
      ...
      /* @__PURE__ */ jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxs(CardContent, { children: [
          contacts.data.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-gray-500 dark:text-gray-400 py-8 text-center", children: "No contacts match this segment’s filters." }) : /* @__PURE__ */ jsx("ul", { className: "divide-y divide-gray-200 dark:divide-gray-700", children: contacts.data.map((contact) => /* @__PURE__ */ jsxs("li", { className: "py-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between", children: [
            ...
            /* @__PURE__ */ jsx(Link, { href: route("app.contacts.show", { contact: contact.slug || contact.id }), className: "w-full sm:w-auto", children: /* @__PURE__ */ jsx(Button, { variant: "secondary", size: "sm", className: "w-full sm:w-auto", children: "View" }) })
          ] }, contact.id)) }),
