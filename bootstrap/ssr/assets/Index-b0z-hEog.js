  ...
  return /* @__PURE__ */ jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between", children: [
        ...
        /* @__PURE__ */ jsx(Link, { href: route("app.broadcasts.create", {}), className: "w-full sm:w-auto", children: /* @__PURE__ */ jsxs(Button, { className: "w-full sm:w-auto bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 shadow-lg shadow-blue-500/50", children: [
      ...
      /* @__PURE__ */ jsx(Card, { className: "border-0 shadow-lg", children: /* @__PURE__ */ jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 md:flex-row", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2 sm:flex", children: [
          ...
          }, className: "w-full sm:w-auto", children: "Reset" }),
          /* @__PURE__ */ jsx(Button, { onClick: applyFilters, className: "w-full sm:w-auto", children: "Apply" })
        ] })
      ] }) }) }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between", children: [
            ...
            /* @__PURE__ */ jsx(
              Link,
              {
                ...
                children: /* @__PURE__ */ jsx(Button, { variant: "secondary", size: "sm", className: "w-full sm:w-auto", children: "View Details" })
              }
            )
          ] }),
