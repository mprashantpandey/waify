...
function Analytics({
  ...
  return /* @__PURE__ */ jsxs(PlatformShell, { auth, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          ...
          /* @__PURE__ */ jsxs(CardDescription, { children: [
            "Total AI credits used across all accounts this billing period ",
            ai_credits_period ? `(${ai_credits_period})` : ""
          ] })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold text-gray-900 dark:text-gray-100", children: formatNumber(ai_credits_platform) }) })
      ] }),
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsx(CardTitle, { children: "Embedded Signup Funnel" }),
          /* @__PURE__ */ jsx(CardDescription, { children: "Where onboarding users drop during WhatsApp Embedded Signup." })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-6 gap-3", children: [
        ...
        ].map((item) => /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-gray-200 dark:border-gray-700 p-3", children: [
          /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500 dark:text-gray-400", children: item.label }),
          /* @__PURE__ */ jsx("div", { className: `text-xl font-semibold ${item.color}`, children: formatNumber(item.value) })
        ] }, item.label)) }) })
      ] }),
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
      ...
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsx(CardTitle, { children: "Top Tenants by Activity" }),
          /* @__PURE__ */ jsx(CardDescription, { children: "Most active tenants in the selected period" })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { children: top_accounts.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-gray-500 dark:text-gray-400 text-center py-8", children: "No tenant data available" }) : /* @__PURE__ */ jsx("div", { className: "space-y-3", children: top_accounts.map((account, index) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-900 dark:text-gray-100", children: account.name }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 dark:text-gray-400", children: account.slug })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
