...
const profileValue = (value, fallback = "") => {
...
function ConnectionsIndex({
  ...
  const [pendingEmbeddedReview, setPendingEmbeddedReview] = useState(null);
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[1100px] space-y-6", children: [
      !connection ? /* @__PURE__ */ jsxs("section", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsx(Card, { className: "p-5 ring-1 ring-waify-green/35", children: /* @__PURE__ */ jsxs("div", { className: "flex h-full flex-col gap-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-waify-text-muted dark:text-waify-dark-text-muted", children: "Connect a new number, migrate an API number, or use eligible WhatsApp app co-existence." })
              ] })
            ] }),
        ...
        connection.connection_mode !== "baileys_qr" && showMetaDetails && /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-3 sm:grid-cols-2", children: [
          ...
          /* @__PURE__ */ jsx(DetailItem, { label: "WhatsApp username", value: connection.business_username ? `@${connection.business_username.replace(/^@+/, "")}` : "Not added" }),
        ...
        connection.connection_mode !== "baileys_qr" && /* @__PURE__ */ jsxs(Card, { children: [
          ...
          /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs("form", { onSubmit: submitProfile, className: "space-y-5", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2", children: [
              ...
              /* @__PURE__ */ jsx(Field, { icon: /* @__PURE__ */ jsx(UserCheck, { className: "h-3.5 w-3.5" }), label: "WhatsApp username", value: profileForm.data.business_username, onChange: (value) => profileForm.setData("business_username", value), error: profileForm.errors.business_username, placeholder: "@yourbrand" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 border-t border-waify-border pt-4 dark:border-waify-dark-border", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2", children: [
                ...
                /* @__PURE__ */ jsxs(Button, { type: "button", size: "sm", variant: "secondary", disabled: profileForm.processing, onClick: syncProfileToMeta, children: [
                  profileForm.processing ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(RefreshCw, { className: "h-4 w-4" }),
                  "Sync to Meta"
                ] })
              ] })
            ] })
...
function SetupWizardDialog({
  ...
  const selectedLabel = selectedPath === "coexistence" ? "WhatsApp app co-existence" : selectedPath === "migrate_api" ? "API number migration" : "New Cloud API number";
  return /* @__PURE__ */ jsx(
    Modal,
    {
      open,
          ...
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "mt-2 text-xs leading-5 text-waify-text-muted dark:text-waify-dark-text-muted", children: "Connect a new or available WhatsApp Business number." })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "mt-2 text-xs leading-5 text-waify-text-muted dark:text-waify-dark-text-muted", children: "Move an existing Cloud API number into Zyptos." })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
                  ...
                  !coexistenceEnabled && /* @__PURE__ */ jsx(Badge, { variant: "warning", children: "Unavailable" })
                ] }),
                /* @__PURE__ */ jsx("p", { className: "mt-2 text-xs leading-5 text-waify-text-muted dark:text-waify-dark-text-muted", children: "Keep the WhatsApp Business app and API together when Meta allows it." })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "rounded-card border border-waify-border bg-gray-50 p-3 text-sm text-waify-text-muted dark:border-waify-dark-border dark:bg-slate-900/70 dark:text-waify-dark-text-muted", children: [
          /* @__PURE__ */ jsx("span", { className: "font-medium text-waify-text dark:text-waify-dark-text", children: "Selected:" }),
          " ",
          selectedLabel
        ] }),
        pendingEmbeddedReview && /* @__PURE__ */ jsx("div", { className: "rounded-card border border-waify-green/40 bg-waify-green-soft/40 p-4 dark:border-waify-green/40 dark:bg-waify-green/10", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsx(CheckCircle2, { className: "mt-0.5 h-5 w-5 flex-shrink-0 text-waify-green-dark dark:text-waify-green" }),
          /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
            /* @__PURE__ */ jsx("h4", { className: "text-sm font-semibold text-waify-text dark:text-waify-dark-text", children: "Confirm this WhatsApp number" }),
            /* @__PURE__ */ jsxs("div", { className: "mt-3 grid gap-2 text-xs text-waify-text-muted dark:text-waify-dark-text-muted sm:grid-cols-2", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("span", { className: "block font-medium text-waify-text dark:text-waify-dark-text", children: "Mode" }),
                pendingEmbeddedReview.summary.mode === "coexistence" ? "App co-existence" : selectedLabel
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("span", { className: "block font-medium text-waify-text dark:text-waify-dark-text", children: "Phone" }),
                pendingEmbeddedReview.summary.businessPhone || "Not returned by Meta"
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("span", { className: "block font-medium text-waify-text dark:text-waify-dark-text", children: "Phone number ID" }),
                pendingEmbeddedReview.summary.phoneNumberId || "Not returned by Meta"
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("span", { className: "block font-medium text-waify-text dark:text-waify-dark-text", children: "WABA ID" }),
                pendingEmbeddedReview.summary.wabaId || "Not returned by Meta"
              ] })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "mt-3 text-xs leading-5 text-waify-text-muted dark:text-waify-dark-text-muted", children: "Zyptos will connect only after you confirm. If this is not the number you expected, cancel and restart setup." })
          ] })
        ] }) }),
  ...
  return /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-sm overflow-hidden rounded-[28px] bg-[#111b21] p-2 shadow-pop", children: /* @__PURE__ */ jsxs("div", { className: "rounded-[22px] bg-[#0b141a] text-[#e9edef]", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 bg-[#075e54] px-4 py-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "truncate text-[11px] text-white/75", children: username ? `@${username}` : phone })
      ] })
    ] }),
