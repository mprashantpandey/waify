...
function Register({ selectedPlan, invite }) {
  ...
  return /* @__PURE__ */ jsxs(Guest, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2", children: invite?.account_name ? `Join ${invite.account_name}` : selectedPlan ? `Start Your ${selectedPlan.trial_days > 0 ? selectedPlan.trial_days + "-Day " : ""}Trial` : "Create your account" }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 dark:text-gray-400", children: invite?.account_name ? `You've been invited as a ${invite.role || "member"}. Create your account to join the team.` : selectedPlan ? `Get started with ${selectedPlan.name} plan. ${selectedPlan.trial_days > 0 ? "No credit card required!" : ""}` : "Get started with your free account today" })
    ] }),
