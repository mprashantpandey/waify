...
import { ExternalLink, ChevronsUpDown, X, ChevronRight, ChevronLeft, GitBranch, PhoneCall, Store, Bell, Radio, Image, ClipboardList, Calendar, Target, ShoppingBag, History, Code2, Shield, HelpCircle, Plug, CalendarRange, Link2, Layout, Wrench, Workflow, Layers, FolderOpen, Tag, List, Building2, Megaphone, Activity, Users, Settings, LifeBuoy, CreditCard, BarChart3, Zap, Sparkles, Bot, Inbox, FileText, MessageCircle, Puzzle, LayoutDashboard, Search, Menu, MessageSquareText, Plus, ChevronDown, User, Keyboard, LogOut, Loader2, Check, Wand2, Reply, Tags } from "lucide-react";
...
import { T as ThemeToggle, B as BrandingWrapper } from "./BrandingWrapper-DdVUILzh.js";
  ...
  return /* @__PURE__ */ jsx("header", { className: "app-header relative z-[120] h-16 flex-shrink-0 border-b border-waify-border bg-white/95 px-4 backdrop-blur dark:border-waify-dark-border dark:bg-waify-dark-surface/95 sm:px-6", children: /* @__PURE__ */ jsxs("div", { className: "flex h-full items-center gap-2 sm:gap-4", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex shrink-0 items-center gap-1 sm:gap-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative hidden md:block", children: [
        ...
        showHelpMenu && /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-10", onClick: () => setShowHelpMenu(false) }),
          /* @__PURE__ */ jsxs("div", { className: "absolute right-0 top-12 z-20 w-64 overflow-hidden rounded-card border border-gray-100 bg-white shadow-pop dark:border-waify-dark-border dark:bg-waify-dark-surface", children: [
            /* @__PURE__ */ jsxs("div", { className: "border-b border-gray-100 px-4 py-3 dark:border-waify-dark-border", children: [
              /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-waify-text dark:text-waify-dark-text", children: "Help" }),
              /* @__PURE__ */ jsx("p", { className: "mt-0.5 text-xs text-waify-text-muted dark:text-waify-dark-text-muted", children: "Get support without leaving your workspace." })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "py-1", children: [
              /* @__PURE__ */ jsx(TopbarMenuLink, { href: effectiveHelpHref, icon: /* @__PURE__ */ jsx(LifeBuoy, { className: "h-4 w-4" }), children: "Support center" }),
              /* @__PURE__ */ jsx(TopbarMenuLink, { href: knowledgeBaseHref, icon: /* @__PURE__ */ jsx(MessageSquareText, { className: "h-4 w-4" }), children: "Knowledge base" }),
              /* @__PURE__ */ jsx(TopbarMenuLink, { href: contactHref, icon: /* @__PURE__ */ jsx(MessageCircle, { className: "h-4 w-4" }), children: "Contact Zyptos" })
            ] })
          ] })
        ] })
      ] }),
        ...
        showUserMenu && /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "absolute right-0 top-12 z-20 w-64 overflow-hidden rounded-card border border-gray-100 bg-white shadow-pop dark:border-waify-dark-border dark:bg-waify-dark-surface", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "py-1", children: [
              ...
              /* @__PURE__ */ jsx(TopbarMenuLink, { href: effectiveHelpHref, icon: /* @__PURE__ */ jsx(LifeBuoy, { className: "h-4 w-4" }), children: "Support" })
            ] }),
