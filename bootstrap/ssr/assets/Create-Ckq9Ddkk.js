...
function PlansCreate({ modules }) {
  ...
  const handleSubmit = (e) => {
    ...
    post(route("platform.plans.store"), {
      ...
      onError: (errors2) => {
        addToast({
          title: "Error",
          description: Object.values(errors2)[0] || "Failed to create plan. Please check the form.",
          variant: "error"
        });
      }
    });
  ...
  return /* @__PURE__ */ jsxs(PlatformShell, { auth, children: [
    /* @__PURE__ */ jsx(Head, { title: "Create Plan" }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-gray-900 dark:text-gray-100", children: "Create Plan" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-gray-500 dark:text-gray-400", children: "Create a new subscription plan" })
        ] })
      ] }),
          ...
          /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 mt-1", children: 'Unique identifier (lowercase, no spaces, e.g., "starter", "pro")' }),
                errors.key && /* @__PURE__ */ jsx("p", { className: "text-sm text-red-600 mt-1", children: errors.key })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 mt-1", children: "Lower numbers appear first" })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: "Visible to workspace owners in plans page" })
              ] }),
              /* @__PURE__ */ jsx(
                Switch,
                {
        ...
        /* @__PURE__ */ jsxs(Card, { children: [
          ...
          /* @__PURE__ */ jsx(CardContent, { className: "space-y-4", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              errors.price_monthly && /* @__PURE__ */ jsx("p", { className: "text-sm text-red-600 mt-1", children: errors.price_monthly })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              errors.price_yearly && /* @__PURE__ */ jsx("p", { className: "text-sm text-red-600 mt-1", children: errors.price_yearly })
            ] })
          ] }) })
        ] }),
        /* @__PURE__ */ jsxs(Card, { children: [
