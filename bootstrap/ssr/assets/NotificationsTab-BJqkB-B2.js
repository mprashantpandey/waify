  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-900", children: [
        /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500 dark:text-gray-400", children: "Enabled preferences" }),
        /* @__PURE__ */ jsxs("div", { className: "mt-1 text-lg font-semibold text-gray-900 dark:text-gray-100", children: [
          enabledCount,
          "/3"
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-900", children: [
        /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500 dark:text-gray-400", children: "Assignments" }),
        /* @__PURE__ */ jsx("div", { className: "mt-1 text-sm font-semibold text-gray-900 dark:text-gray-100", children: data.notify_assignment_enabled ? "On" : "Off" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-900", children: [
        /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500 dark:text-gray-400", children: "Mentions + sound" }),
        /* @__PURE__ */ jsxs("div", { className: "mt-1 text-sm font-semibold text-gray-900 dark:text-gray-100", children: [
          data.notify_mention_enabled ? "Mentions on" : "Mentions off",
          " · ",
          data.notify_sound_enabled ? "Sound on" : "Sound off"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs(Card, { className: "border-0 shadow-lg", children: [
      ...
      /* @__PURE__ */ jsxs(CardContent, { className: "p-6", children: [
        /* @__PURE__ */ jsx("div", { className: "mb-4 rounded-xl border border-blue-100 bg-blue-50/60 p-3 text-sm text-blue-800 dark:border-blue-900/60 dark:bg-blue-900/20 dark:text-blue-200", children: "These preferences affect your personal in-app alerts only. They do not change tenant-wide routing or campaign behavior." }),
        /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-5", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3", children: [
              ...
              /* @__PURE__ */ jsxs("label", { className: "relative inline-flex items-center cursor-pointer self-start sm:self-auto", children: [
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "checkbox",
