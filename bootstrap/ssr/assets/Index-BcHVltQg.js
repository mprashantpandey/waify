...
function ContactsIndex({
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      router.get(route("app.contacts.index", {}), { search: normalizedSearch || void 0, status: filters.status || void 0 }, {
        preserveState: true,
        preserveScroll: true,
        replace: true,
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    router.get(route("app.contacts.index", {}), { search: search.trim() || void 0, status: filters.status || void 0 }, {
      preserveState: true,
      preserveScroll: true,
      replace: true,
      only: ["contacts", "contactStats", "filters", "selectedContact"]
      ...
      /* @__PURE__ */ jsx(
        Drawer,
        {
          ...
          children: drawerMode === "create" ? /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 rounded-card border border-gray-100 p-4 dark:border-waify-dark-border", children: [
              /* @__PURE__ */ jsx("div", { className: "h-12 w-12 animate-pulse rounded-full bg-gray-100 dark:bg-waify-dark-surface-2" }),
              /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-2", children: [
                /* @__PURE__ */ jsx("div", { className: "h-4 w-40 animate-pulse rounded bg-gray-100 dark:bg-waify-dark-surface-2" }),
                /* @__PURE__ */ jsx("div", { className: "h-3 w-28 animate-pulse rounded bg-gray-100 dark:bg-waify-dark-surface-2" })
              ] })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "rounded-card border border-dashed border-gray-200 p-4 text-sm text-waify-text-muted dark:border-waify-dark-border dark:text-waify-dark-text-muted", children: "Loading contact details. If this continues, return to Contacts and select the contact again." })
          ] })
        }
      )
    ] })
