...
function ConnectionsEdit({
  ...
  const [metaInsightsError, setMetaInsightsError] = useState(null);
  ...
  const runConnectionTest = async () => {
    ...
    try {
      ...
      const summary = [
        ...
        data2.quality_rating ? `Quality: ${data2.quality_rating}` : null,
        data2.messaging_limit_tier ? `Limit: ${data2.messaging_limit_tier}` : null,
        data2.waba_match === false ? "WhatsApp Business Account mismatch" : null
      ].filter(Boolean).join(" · ");
  ...
  const loadMetaInsights = async () => {
    ...
    try {
      ...
      setMetaInsights(data2?.insights ?? null);
    } catch (error) {
  ...
  return /* @__PURE__ */ jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
      ...
      /* @__PURE__ */ jsxs(Card, { className: "border-0 shadow-xl", children: [
        /* @__PURE__ */ jsx(CardHeader, { className: "bg-gradient-to-r from-violet-50 to-indigo-100 dark:from-violet-900/20 dark:to-indigo-800/20", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(CardTitle, { className: "text-xl font-bold", children: "Meta Account Insights" }),
            /* @__PURE__ */ jsx(CardDescription, { children: "View WhatsApp Business Account status, quality rating, messaging limits, and linked numbers." })
          ] }),
          /* @__PURE__ */ jsx(Button, { variant: "secondary", onClick: loadMetaInsights, disabled: metaInsightsLoading, children: metaInsightsLoading ? "Refreshing..." : "Refresh" })
        ] }) }),
        /* @__PURE__ */ jsxs(CardContent, { className: "p-6 space-y-5", children: [
          metaInsightsError && /* @__PURE__ */ jsx(Alert, { variant: "error", children: metaInsightsError }),
          !metaInsightsError && metaInsightsLoading && /* @__PURE__ */ jsx(Alert, { variant: "info", children: "Loading Meta details..." }),
          metaInsights?.waba && /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-gray-200 dark:border-gray-700 p-4 space-y-2", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-sm font-semibold text-gray-800 dark:text-gray-100", children: "WhatsApp Business Account" }),
            /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-600 dark:text-gray-300", children: [
              "Name: ",
              metaInsights.waba.name || "—"
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-600 dark:text-gray-300", children: [
              "WhatsApp Business Account ID: ",
              /* @__PURE__ */ jsx("span", { className: "font-mono", children: metaInsights.waba.id || "—" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-600 dark:text-gray-300", children: [
              "Review Status: ",
              metaInsights.waba.account_review_status || "Unknown"
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-600 dark:text-gray-300", children: [
              "Business Verification: ",
              metaInsights.business_verification.status
            ] })
          ] }),
          metaInsights?.selected_phone && /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-gray-200 dark:border-gray-700 p-4 space-y-2", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-sm font-semibold text-gray-800 dark:text-gray-100", children: "Selected Phone Number" }),
            /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-600 dark:text-gray-300", children: [
              "Display Number: ",
              metaInsights.selected_phone.display_phone_number || "—"
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-600 dark:text-gray-300", children: [
              "Verified Name: ",
              metaInsights.selected_phone.verified_name || "—"
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-600 dark:text-gray-300", children: [
              "Quality Rating: ",
              metaInsights.selected_phone.quality_rating || "Unknown"
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-600 dark:text-gray-300", children: [
              "Messaging Limit Tier: ",
              metaInsights.selected_phone.messaging_limit_tier || "Unknown"
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-600 dark:text-gray-300", children: [
              "Code Verification Status: ",
              metaInsights.selected_phone.code_verification_status || "Unknown"
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-gray-200 dark:border-gray-700 p-4", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-sm font-semibold text-gray-800 dark:text-gray-100 mb-3", children: "All Linked Phone Numbers" }),
            metaInsights?.phone_numbers?.length ? /* @__PURE__ */ jsx("div", { className: "space-y-2", children: metaInsights.phone_numbers.map((phone, index) => /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-600 dark:text-gray-300 border-b border-dashed border-gray-200 dark:border-gray-700 pb-2 last:border-0", children: [
              /* @__PURE__ */ jsx("div", { className: "font-mono", children: phone.id || "—" }),
              /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                " · Limit: ",
                phone.messaging_limit_tier || "Unknown"
              ] })
            ] }, phone.id || `phone-${index}`)) }) : /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-500", children: "No linked numbers were returned from Meta." })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-900/20 p-4 text-sm text-amber-800 dark:text-amber-200 space-y-2", children: [
            /* @__PURE__ */ jsx("div", { className: "font-semibold", children: "Compliance & Setup Actions" }),
            /* @__PURE__ */ jsxs("div", { children: [
              "Complete Meta Business Verification:",
              /* @__PURE__ */ jsx("a", { href: metaInsights?.business_verification?.help_url || "https://business.facebook.com/settings/security-center", target: "_blank", rel: "noreferrer", className: "ml-1 underline", children: "Open Security Center" })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              "Add/manage phone numbers:",
              /* @__PURE__ */ jsx("a", { href: metaInsights?.manage_numbers_url || "https://business.facebook.com/latest/whatsapp_manager/phone_numbers", target: "_blank", rel: "noreferrer", className: "ml-1 underline", children: "Open WhatsApp Manager" })
            ] })
          ] })
        ] })
      ] }),
