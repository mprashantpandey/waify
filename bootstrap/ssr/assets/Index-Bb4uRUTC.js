...
import { Tag, FolderOpen, Download, Plus, Search, Filter, Users, Loader2, Trash2 } from "lucide-react";
  ...
  return /* @__PURE__ */ jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 sm:flex sm:flex-wrap gap-2", children: [
          /* @__PURE__ */ jsx(Link, { href: route("app.contacts.tags.index"), className: "col-span-1", children: /* @__PURE__ */ jsxs(Button, { variant: "secondary", className: "w-full sm:w-auto", children: [
            /* @__PURE__ */ jsx(Tag, { className: "h-4 w-4 mr-2" }),
            "Tags"
          ] }) }),
          /* @__PURE__ */ jsx(Link, { href: route("app.contacts.segments.index"), className: "col-span-1", children: /* @__PURE__ */ jsxs(Button, { variant: "secondary", className: "w-full sm:w-auto", children: [
            /* @__PURE__ */ jsx(FolderOpen, { className: "h-4 w-4 mr-2" }),
            "Segments"
          ] }) }),
          /* @__PURE__ */ jsx(Link, { href: route("app.contacts.export", {}), className: "col-span-1", children: /* @__PURE__ */ jsxs(Button, { variant: "secondary", className: "w-full sm:w-auto", children: [
            /* @__PURE__ */ jsx(Download, { className: "h-4 w-4 mr-2" }),
            "Export"
          ] }) }),
          /* @__PURE__ */ jsx(Link, { href: route("app.contacts.create", {}), className: "col-span-1", children: /* @__PURE__ */ jsxs(Button, { className: "w-full sm:w-auto bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700", children: [
            /* @__PURE__ */ jsx(Plus, { className: "h-4 w-4 mr-2" }),
            "Add Contact"
          ] }) })
        ] })
      ] }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSearch, className: "grid grid-cols-1 sm:grid-cols-[minmax(0,1fr)_auto_auto] gap-2", children: [
        ...
        /* @__PURE__ */ jsx(Button, { type: "submit", className: "w-full sm:w-auto", children: "Search" }),
        /* @__PURE__ */ jsxs(
          Button,
          {
            type: "button",
      ...
      contacts.data.length === 0 ? /* @__PURE__ */ jsx(Card, { className: "border-0 shadow-xl", children: /* @__PURE__ */ jsx(CardContent, { className: "py-16 text-center", children: /* @__PURE__ */ jsx(
        ...
        contacts.data.map((contact) => /* @__PURE__ */ jsx(Card, { className: "border-0 shadow-lg hover:shadow-xl transition-shadow", children: /* @__PURE__ */ jsx(CardContent, { className: "p-6", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-stretch sm:items-center gap-2 lg:shrink-0", children: [
            /* @__PURE__ */ jsxs(
              Button,
              {
                size: "sm",
            ...
            /* @__PURE__ */ jsx(
              Link,
              {
                ...
                className: "w-full sm:w-auto",
                children: /* @__PURE__ */ jsx(Button, { variant: "secondary", size: "sm", className: "w-full sm:w-auto", children: "View" })
              }
            ),
            /* @__PURE__ */ jsx(
              Button,
              {
                ...
                children: deletingContactId === contact.id ? /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 animate-spin" }) : /* @__PURE__ */ jsx(Trash2, { className: "h-3.5 w-3.5 text-red-600" })
              }
            )
          ] })
        ] }) }) }, contact.id)),
