    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, children: [
        ...
        /* @__PURE__ */ jsxs(Card, { className: "mt-6", children: [
          ...
          /* @__PURE__ */ jsx(CardContent, { className: "space-y-4", children: data.filters.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400", children: "No filters. Add a rule to limit which contacts are in this segment, or leave empty to leave the segment empty until you add rules later." }) : data.filters.map((filter, index) => /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-end gap-2 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-6 flex gap-4", children: [
          /* @__PURE__ */ jsx(Button, { type: "submit", disabled: processing, children: "Create segment" }),
          /* @__PURE__ */ jsx(Link, { href: route("app.contacts.segments.index"), children: /* @__PURE__ */ jsx(Button, { type: "button", variant: "secondary", children: "Cancel" }) })
        ] })
      ] })
    ] })
  ] });
