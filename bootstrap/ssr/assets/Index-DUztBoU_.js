  ...
  return /* @__PURE__ */ jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-gray-200 dark:border-gray-800 bg-gradient-to-br from-white to-blue-50/60 dark:from-gray-900 dark:to-blue-900/20 p-6 shadow-sm", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 sm:flex-row", children: [
            canCreate && /* @__PURE__ */ jsx(Link$1, { href: route("app.whatsapp.connections.create", {}), children: /* @__PURE__ */ jsxs(Button, { className: "bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 shadow-lg shadow-blue-500/40", children: [
              /* @__PURE__ */ jsx(Plus, { className: "h-4 w-4 mr-2" }),
              "Add Connection"
            ] }) }),
            /* @__PURE__ */ jsx(Link$1, { href: route("app.whatsapp.connections.wizard", {}), children: /* @__PURE__ */ jsxs(Button, { variant: "secondary", className: "border-blue-200/60 text-blue-700 hover:bg-blue-50 dark:border-blue-800/60 dark:text-blue-200 dark:hover:bg-blue-900/30", children: [
      ...
      filteredConnections.length === 0 ? /* @__PURE__ */ jsx(Card, { className: "border-0 shadow-xl", children: /* @__PURE__ */ jsxs(CardContent, { className: "py-16 text-center", children: [
        ...
        canCreate && /* @__PURE__ */ jsx(Link$1, { href: route("app.whatsapp.connections.create", {}), children: /* @__PURE__ */ jsxs(Button, { className: "bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 shadow-lg shadow-blue-500/50", children: [
          /* @__PURE__ */ jsx(Plus, { className: "h-4 w-4 mr-2" }),
          "Create Connection"
        ] }) })
