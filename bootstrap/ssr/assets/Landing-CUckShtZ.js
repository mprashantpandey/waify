...
import { Sparkles, BadgeCheck, ArrowRight, Users, Zap, FileText, Send, Inbox, MessageSquare, Globe, Shield, CheckCircle2, Rocket, Gem, Target, TrendingUp } from "lucide-react";
...
function Landing({
  ...
  return /* @__PURE__ */ jsxs(PublicLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: `${platformName} | WhatsApp Cloud Platform` }),
    /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-center gap-3 mb-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-full", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 border-2 border-emerald-500/50 dark:border-emerald-400/50 rounded-full shadow-sm", children: [
          /* @__PURE__ */ jsx(BadgeCheck, { className: "h-4 w-4 text-emerald-600 dark:text-emerald-400" }),
          /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-emerald-700 dark:text-emerald-300", children: "Official Meta Tech Provider" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("h1", { className: "text-5xl md:text-7xl font-bold text-gray-900 dark:text-gray-100 mb-6 gradient-text leading-tight", children: [
        "WhatsApp Cloud Platform",
        /* @__PURE__ */ jsx("br", {}),
        /* @__PURE__ */ jsx("span", { className: "gradient-text-accent", children: "Built for Scale" })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-xl md:text-2xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-8 leading-relaxed", children: "As an official Meta Tech Provider, we help you connect Meta WhatsApp Cloud API, manage templates, run chatbots, automate messages, and scale your customer communication with enterprise-grade features." }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2 gradient-text", children: "Platform Activity" }),
    ...
    /* @__PURE__ */ jsx("div", { id: "features", className: "bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 py-20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-16", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "text-4xl md:text-5xl font-bold text-gray-900 dark:text-gray-100 mb-4 gradient-text", children: "Everything You Need" }),
    ...
    /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 dark:from-green-900/20 dark:via-blue-900/20 dark:to-purple-900/20 py-16 border-t border-gray-200 dark:border-gray-800", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
        ...
        /* @__PURE__ */ jsxs("h2", { className: "text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4 gradient-text", children: [
          "Why Choose ",
          platformName,
          "?"
        ] })
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 text-center card-hover", children: [
          /* @__PURE__ */ jsx("div", { className: "inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 text-white mb-4", children: /* @__PURE__ */ jsx(Rocket, { className: "h-7 w-7" }) }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 text-center card-hover", children: [
          /* @__PURE__ */ jsx("div", { className: "inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 text-white mb-4", children: /* @__PURE__ */ jsx(Gem, { className: "h-7 w-7" }) }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 text-center card-hover", children: [
          /* @__PURE__ */ jsx("div", { className: "inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 text-white mb-4", children: /* @__PURE__ */ jsx(Target, { className: "h-7 w-7" }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 py-20 relative overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-black/10", "aria-hidden": "true" }),
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_0%,rgba(0,0,0,0.08)_100%)]", "aria-hidden": "true" }),
      /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-4xl md:text-5xl font-bold text-white mb-4 text-balance", children: "Ready to Transform Your Business Communication?" }),
        /* @__PURE__ */ jsxs("p", { className: "text-xl text-blue-100 mb-8", children: [
          ...
          /* @__PURE__ */ jsx("br", {}),
          /* @__PURE__ */ jsx("span", { className: "font-semibold text-white/95", children: "Start your free trial today — no credit card required." })
        ] }),
...
function FeatureCard({ icon: Icon, title, description }) {
  return /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 card-hover", children: [
    /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 w-12 h-12 rounded-xl flex items-center justify-center mb-4", children: /* @__PURE__ */ jsx(Icon, { className: "h-6 w-6 text-blue-600 dark:text-blue-400" }) }),
