...
function Guest({ children, maxWidthClass = "max-w-md" }) {
  const { branding } = usePage().props;
  const platformName = getPlatformName(branding);
  const logoUrl = getLogoUrl(branding);
  return /* @__PURE__ */ jsx(BrandingWrapper, { children: /* @__PURE__ */ jsx("div", { className: "min-h-screen overflow-x-hidden flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 px-4 py-8 sm:py-12", children: /* @__PURE__ */ jsxs("div", { className: `w-full mx-auto ${maxWidthClass}`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-800 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "p-5 sm:p-8", children })
    ] })
  ] }) }) });
}
export {
