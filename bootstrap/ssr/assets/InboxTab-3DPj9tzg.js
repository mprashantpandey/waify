  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-900", children: [
        /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500 dark:text-gray-400", children: "Auto-assignment" }),
        /* @__PURE__ */ jsx("div", { className: "mt-1 text-sm font-semibold text-gray-900 dark:text-gray-100", children: data.auto_assign_enabled ? "Enabled" : "Disabled" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-900", children: [
        /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500 dark:text-gray-400", children: "Strategy" }),
        /* @__PURE__ */ jsx("div", { className: "mt-1 text-sm font-semibold text-gray-900 dark:text-gray-100 capitalize", children: data.auto_assign_enabled ? data.auto_assign_strategy.replace("_", " ") : "Manual assignment" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs(Card, { className: "border-0 shadow-lg", children: [
      ...
      /* @__PURE__ */ jsxs(CardContent, { className: "p-6", children: [
        /* @__PURE__ */ jsx("div", { className: "mb-4 rounded-xl border border-emerald-100 bg-emerald-50/70 p-3 text-sm text-emerald-800 dark:border-emerald-900/50 dark:bg-emerald-900/20 dark:text-emerald-200", children: "Routing changes apply to new incoming conversations. Existing assignments remain unchanged." }),
