...
import { FileText, Loader2, RefreshCw, Filter, Search, X, Check, Copy, Globe, Tag, Zap, Send, Archive, Trash2 } from "lucide-react";
...
function TemplatesIndex({
  ...
  return /* @__PURE__ */ jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-stretch sm:items-center gap-2", children: [
          /* @__PURE__ */ jsx(
            Link,
            {
              ...
              children: /* @__PURE__ */ jsxs(Button, { className: "w-full sm:w-auto bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 shadow-lg shadow-blue-500/50", children: [
          ...
          /* @__PURE__ */ jsxs(
            Button,
            {
              ...
              children: [
                syncing ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 mr-2 animate-spin" }) : /* @__PURE__ */ jsx(RefreshCw, { className: "h-4 w-4 mr-2" }),
      ...
      (sync_report || connections.some((c) => c.last_synced_at || c.last_sync_error)) && /* @__PURE__ */ jsxs(Card, { className: "border-0 shadow-lg", children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsx(CardTitle, { children: "Sync Status Report" }),
          /* @__PURE__ */ jsx(CardDescription, { children: "Latest sync summary and per-connection status" })
        ] }),
        /* @__PURE__ */ jsxs(CardContent, { className: "space-y-3 text-sm", children: [
          sync_report && /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-gray-200 dark:border-gray-700 p-3", children: [
            ...
            Array.isArray(sync_report.errors) && sync_report.errors.length > 0 && /* @__PURE__ */ jsx("ul", { className: "mt-2 space-y-1 text-red-600 dark:text-red-400", children: sync_report.errors.map((err, idx) => /* @__PURE__ */ jsxs("li", { children: [
              err.template,
              ": ",
              err.error
            ] }, idx)) })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "grid gap-2 md:grid-cols-2", children: connections.map((connection) => /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-gray-200 dark:border-gray-700 p-3", children: [
            /* @__PURE__ */ jsx("p", { className: "font-medium", children: connection.name }),
            ...
            connection.last_sync_error && /* @__PURE__ */ jsxs("p", { className: "mt-1 text-xs text-red-600 dark:text-red-400 truncate", children: [
              "Last error: ",
