      ...
      /* @__PURE__ */ jsxs(Card, { className: "border-0 shadow-lg", children: [
        ...
        /* @__PURE__ */ jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full", children: [
          /* @__PURE__ */ jsx("thead", { className: "bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700", children: /* @__PURE__ */ jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsx("th", { className: "px-6 py-3 text-left text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider", children: "Actions" })
          ] }) }),
          /* @__PURE__ */ jsxs("tbody", { className: "divide-y divide-gray-200 dark:divide-gray-800 bg-white dark:bg-gray-900", children: [
            payments.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 8, className: "px-6 py-8 text-center text-sm text-gray-500 dark:text-gray-400", children: "No payments recorded yet." }) }),
            payments.map((payment) => /* @__PURE__ */ jsxs("tr", { children: [
              ...
              /* @__PURE__ */ jsx("td", { className: "px-6 py-4 text-sm", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsx(Link, { href: route("app.billing.history.show", { paymentOrder: payment.id }), className: "text-blue-600 hover:underline", children: "View" }),
                /* @__PURE__ */ jsx("a", { href: route("app.billing.history.download", { paymentOrder: payment.id }), className: "text-gray-700 dark:text-gray-300 hover:underline", children: "Download" })
              ] }) })
            ] }, payment.id))
          ] })
        ] }) }) })
