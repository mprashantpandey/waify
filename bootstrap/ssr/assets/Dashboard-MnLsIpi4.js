  ...
  return /* @__PURE__ */ jsx(PlatformShell, { auth, children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6", children: [
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600 dark:text-gray-400", children: "Total Tenants" }),
          /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2", children: formatNumber(stats.total_accounts) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      ...
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsx(CardTitle, { children: "Top Tenants by Volume" }),
          /* @__PURE__ */ jsx(CardDescription, { children: "Most active tenants (last 30 days)" })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { children: top_accounts.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-gray-500 dark:text-gray-400 text-center py-8", children: "No message data available" }) : /* @__PURE__ */ jsx("div", { className: "space-y-3", children: top_accounts.map((account, index) => /* @__PURE__ */ jsxs(
          Link$1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-gray-900 dark:text-gray-100", children: formatNumber(account.message_count) })
              ] })
            ]
          },
          account.id
    ...
    /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(CardTitle, { children: "Recent Tenants" }),
          /* @__PURE__ */ jsx(CardDescription, { children: "Newly created tenants" })
        ] }),
        /* @__PURE__ */ jsx(
          Link$1,
          {
      ...
      /* @__PURE__ */ jsx(CardContent, { children: recent_accounts.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-gray-500 dark:text-gray-400 text-center py-8", children: "No tenants yet" }) : /* @__PURE__ */ jsx("div", { className: "divide-y divide-gray-200 dark:divide-gray-800", children: recent_accounts.map((account) => /* @__PURE__ */ jsx(
        Link$1,
        {
          href: route("platform.accounts.show", { account: account.id }),
