...
function AiTab({ data, setData, errors }) {
  ...
  const sttProvider = ai.voice_stt_provider || "elevenlabs";
  const ttsProvider = ai.voice_tts_provider || "elevenlabs";
  ...
  return /* @__PURE__ */ jsxs(Card, { className: "border-0 shadow-lg", children: [
    ...
    /* @__PURE__ */ jsxs(CardContent, { className: "p-6 space-y-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-500 mt-1", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "font-medium", children: "gemini-2.0-flash" })
            ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-gray-200 bg-gray-50/50 p-4 space-y-5 dark:border-gray-700 dark:bg-gray-800/30", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h4", { className: "text-sm font-semibold text-gray-900 dark:text-gray-100", children: "Voice AI" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 dark:text-gray-400", children: "Central speech-to-text and text-to-speech for WhatsApp calling." })
          ] }),
          /* @__PURE__ */ jsx(
            Switch,
            {
        ...
        /* @__PURE__ */ jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsx(Button, { type: "button", variant: "secondary", onClick: testVoice, disabled: !ai.voice_enabled, children: "Test voice" }) }),
        /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-3", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "ai.voice_stt_provider", children: "Speech-to-text" }),
            /* @__PURE__ */ jsxs(
              "select",
              {
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "ai.voice_tts_provider", children: "Text-to-speech" }),
            /* @__PURE__ */ jsxs(
              "select",
              {
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "ai.voice_fallback_provider", children: "Fallback" }),
            /* @__PURE__ */ jsxs(
              "select",
              {
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-4 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-900/40", children: [
            /* @__PURE__ */ jsx("h5", { className: "text-sm font-semibold text-gray-900 dark:text-gray-100", children: "ElevenLabs" }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(Label, { htmlFor: "ai.elevenlabs_api_key", children: "API Key" }),
              /* @__PURE__ */ jsx(
                TextInput,
                {
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(Label, { htmlFor: "ai.elevenlabs_voice_id", children: "Voice ID" }),
              /* @__PURE__ */ jsx(
                TextInput,
                {
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid gap-3 md:grid-cols-2", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(Label, { htmlFor: "ai.elevenlabs_stt_model", children: "STT model" }),
                /* @__PURE__ */ jsx(
                  TextInput,
                  {
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(Label, { htmlFor: "ai.elevenlabs_tts_model", children: "TTS model" }),
                /* @__PURE__ */ jsx(
                  TextInput,
                  {
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-4 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-900/40", children: [
            /* @__PURE__ */ jsx("h5", { className: "text-sm font-semibold text-gray-900 dark:text-gray-100", children: "OpenAI fallback" }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(Label, { htmlFor: "ai.voice_openai_api_key", children: "Voice API key" }),
              /* @__PURE__ */ jsx(
                TextInput,
                {
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid gap-3 md:grid-cols-2", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(Label, { htmlFor: "ai.openai_stt_model", children: "STT model" }),
                /* @__PURE__ */ jsx(
                  TextInput,
                  {
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(Label, { htmlFor: "ai.openai_tts_model", children: "TTS model" }),
                /* @__PURE__ */ jsx(
                  TextInput,
                  {
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(Label, { htmlFor: "ai.openai_voice", children: "Voice" }),
              /* @__PURE__ */ jsx(
                TextInput,
                {
                  id: "ai.openai_voice",
