            ...
            <div className="space-y-5">
                <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                        <div className="max-w-2xl">
                            <h1 className="text-3xl font-semibold tracking-tight text-gray-950 dark:text-white">Dashboard</h1>
                            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                Start with the next pending step, then return to your inbox.
                            </p>
                        </div>
                        <div className="flex flex-wrap gap-3">
                            ...
                            {hasRoute('app.whatsapp.connections.index') && (
                                <Link href={route('app.whatsapp.connections.index', {})}>
                                    <Button variant="secondary" className="rounded-xl px-5">Connections</Button>
                                </Link>
                            )}
                    ...
                    <section className="rounded-2xl border border-amber-200 bg-amber-50 p-4 shadow-sm dark:border-amber-900/60 dark:bg-amber-950/20">
                        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-semibold text-amber-900 dark:text-amber-200">Connection attention required</p>
                                    <p className="mt-1 text-sm text-amber-800/80 dark:text-amber-300/80">
                                        {connection_alerts[0].name} still needs setup or review.
                                    </p>
                                </div>
                            </div>
                            {hasRoute('app.whatsapp.connections.index') && (
                                <Link href={route('app.whatsapp.connections.index', {})}>
                                    <Button variant="secondary" size="sm" className="rounded-xl">Review</Button>
                                </Link>
                            )}
                        </div>
                    </section>
                ...
                <section className="grid grid-cols-2 gap-4 xl:grid-cols-4">
                    {statCards.map((stat) => {
                        ...
                        return (
                            <Card key={stat.label} className="border border-gray-200 shadow-sm dark:border-gray-800">
                                <CardContent className="p-5">
                                    <div className="flex items-start justify-between gap-3">
                                        ...
                                        <div className="rounded-xl bg-gray-50 p-3 text-gray-700 dark:bg-gray-800 dark:text-gray-200">
                            ...
                            <CardContent className="space-y-3">
                                {onboarding_checklist?.show ? (
                                    <>
                                            ...
                                            >
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    <div className="flex items-center justify-between gap-3">
                                                        ...
                                                        <span className="text-xs text-gray-500 dark:text-gray-400">{item.done ? 'Done' : 'Open'}</span>
                                                    </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            <div className="rounded-2xl border border-gray-200 p-4 dark:border-gray-800">
                                                ...
                                                <div className="mt-2 text-2xl font-semibold text-gray-950 dark:text-white">{onboarding_checklist.completed}/{onboarding_checklist.total}</div>
                                            </div>
                                            <div className="rounded-2xl border border-gray-200 p-4 dark:border-gray-800">
                                                <div className="text-sm text-gray-500 dark:text-gray-400">Healthy numbers</div>
                                    ...
                                    <div className="rounded-2xl border border-gray-200 bg-gray-50 p-4 text-sm text-gray-600 dark:border-gray-800 dark:bg-gray-950 dark:text-gray-400">
                                        Your account is ready. Open inbox to continue customer replies.
                                    </div>
                                )}
                            </CardContent>
                        </Card>
                    ...
                    <div className="space-y-4">
                        <Card className="border border-gray-200 shadow-sm dark:border-gray-800">
                            <CardHeader className="pb-3">
                                ...
                                <CardDescription>Open the pages you use most.</CardDescription>
                            </CardHeader>
                        ...
                        {customer_start_conversation && (
                            <Card className="border border-gray-200 shadow-sm dark:border-gray-800">
                                <CardHeader className="pb-3">
                                    ...
                                    <CardDescription>Share one link or QR code so customers can message you directly.</CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    {customer_start_conversation.start_link ? (
                                        <>
                                            <div className="rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-950">
                                                <div className="rounded-xl border border-gray-200 bg-white p-3 text-xs break-all text-gray-700 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300">
                                                    {customer_start_conversation.start_link}
                                                </div>
                                                ...
                                                {dashboardWidgetQr ? (
                                                    <div className="flex justify-center">
                                                        <img
                                                            ...
                                                            className="h-48 w-48 rounded-2xl border border-gray-200 bg-white p-3 dark:border-gray-700"
                                                        />
                                                    </div>
                                                ) : (
                                                    <div className="flex h-48 items-center justify-center rounded-2xl border border-dashed border-gray-300 text-sm text-gray-500 dark:border-gray-700">
                                                        QR unavailable
                                                    </div>
                                                )}
                                            </div>
