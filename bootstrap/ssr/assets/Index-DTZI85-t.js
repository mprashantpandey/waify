...
import { UserPlus, Sparkles, Mail, Loader2, Calendar, Edit, Trash2, Crown, Shield, User } from "lucide-react";
...
function TeamIndex({
  ...
  const [memberActionKey, setMemberActionKey] = useState(null);
  const [inviteActionKey, setInviteActionKey] = useState(null);
  const handleInvite = () => {
    if (!inviteEmail) {
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
      ...
      showInviteDialog && /* @__PURE__ */ jsxs(Card, { className: "border-0 shadow-xl", children: [
        ...
        /* @__PURE__ */ jsxs(CardContent, { className: "space-y-5 pt-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col-reverse sm:flex-row items-stretch sm:items-center gap-3 pt-2", children: [
            /* @__PURE__ */ jsx(Button, { onClick: handleInvite, disabled: inviteSubmitting || !inviteEmail.trim(), className: "w-full sm:flex-1 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700", children: inviteSubmitting ? /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 mr-2 animate-spin" }),
              "Sending..."
            ] }) : "Send Invitation" }),
            /* @__PURE__ */ jsx(Button, { variant: "secondary", onClick: () => setShowInviteDialog(false), className: "w-full sm:flex-1", disabled: inviteSubmitting, children: "Cancel" })
          ] })
        ] })
      ] }),
        ...
        /* @__PURE__ */ jsx(CardContent, { className: "pt-6 space-y-3", children: pending_invites.map((invite) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:shrink-0", children: [
                /* @__PURE__ */ jsx(
                  Button,
                  {
                    variant: "secondary",
                    ...
                    children: inviteActionKey === `resend:${invite.id}` ? /* @__PURE__ */ jsxs(Fragment, { children: [
                      /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 mr-1 animate-spin" }),
                      "Resending"
                    ] }) : "Resend"
                  }
                ),
                /* @__PURE__ */ jsx(
                  Button,
                  {
                    ...
                    disabled: inviteActionKey !== null,
                    className: "w-full sm:w-auto",
                    children: inviteActionKey === `revoke:${invite.id}` ? /* @__PURE__ */ jsxs(Fragment, { children: [
                      /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 mr-1 animate-spin" }),
                      "Revoking"
                    ] }) : "Revoke"
                  }
      ...
      /* @__PURE__ */ jsxs(Card, { className: "border-0 shadow-lg", children: [
        /* @__PURE__ */ jsx(CardHeader, { className: "bg-gradient-to-r from-gray-50 to-white dark:from-gray-800 dark:to-gray-900", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between", children: /* @__PURE__ */ jsxs("div", { children: [
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 flex-1", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center gap-1.5 sm:gap-3 text-sm text-gray-500 dark:text-gray-400", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
                      /* @__PURE__ */ jsx(Mail, { className: "h-3.5 w-3.5" }),
                      /* @__PURE__ */ jsx("span", { className: "break-all", children: member.email })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center gap-3", children: [
                ...
                can_manage && !member.is_owner && member.id !== current_user_id && /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2", children: editingMember?.id === member.id ? /* @__PURE__ */ jsxs(
                  "select",
                  {
                    ...
                    children: [
                      member.role !== "member" && /* @__PURE__ */ jsx("option", { value: member.role, children: member.role === "admin" ? "Legacy Admin" : member.role }),
                      /* @__PURE__ */ jsx("option", { value: "member", children: "Chat Agent" })
                    ]
                  }
                  ...
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      ...
                      children: memberActionKey === `remove:${member.id}` ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Trash2, { className: "h-4 w-4" })
                    }
                  )
                ] }) })
              ] })
