      ...
      /* @__PURE__ */ jsxs(Card, { className: "border-0 shadow-lg", children: [
        ...
        /* @__PURE__ */ jsxs(CardContent, { className: "p-6 space-y-6", children: [
          ...
          wizardState.step === "complete" && wizardState.progress === 100 && /* @__PURE__ */ jsxs("div", { className: "text-center py-8", children: [
            ...
            /* @__PURE__ */ jsx(Link, { href: route("app.whatsapp.connections.index", { workspace: workspace.slug }), children: /* @__PURE__ */ jsx(Button, { className: "bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 shadow-lg shadow-blue-500/50 rounded-xl", children: "View Connections" }) })
          ] })
        ] })
      ] })
    ] })
