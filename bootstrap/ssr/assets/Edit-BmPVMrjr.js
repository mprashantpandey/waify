...
import { ArrowLeft, Copy, MessageCircle, QrCode, Palette, Sparkles } from "lucide-react";
...
function FloatersEdit({
  ...
  const [startChatQr, setStartChatQr] = useState(null);
  useEffect(() => {
  ...
  const startConversationLink = normalizedWhatsAppPhone ? `https://wa.me/${normalizedWhatsAppPhone}${startConversationText ? `?text=${encodeURIComponent(startConversationText)}` : ""}` : "";
  useEffect(() => {
    let active = true;
  ...
  return /* @__PURE__ */ jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
      ...
      embed.supported && embed.snippet && embed.script && /* @__PURE__ */ jsxs(Card, { className: "border-0 shadow-lg", children: [
      ...
      /* @__PURE__ */ jsxs(Card, { className: "border-0 shadow-lg", children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx(CardTitle, { children: "Customer Start Conversation" })
          ] }),
          /* @__PURE__ */ jsx(CardDescription, { children: "Share this link or QR code with customers to start a WhatsApp chat instantly." })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { className: "space-y-4", children: startConversationLink ? /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-[1fr,280px]", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsx(InputLabel, { value: "Start Conversation Link" }),
            /* @__PURE__ */ jsx("div", { className: "rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 p-3 text-xs text-gray-600 dark:text-gray-300 break-all", children: startConversationLink }),
            /* @__PURE__ */ jsx("div", { className: "flex flex-wrap items-center gap-3", children: /* @__PURE__ */ jsxs(
              Button,
              {
                variant: "secondary",
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 p-3 flex flex-col items-center justify-center", children: [
            /* @__PURE__ */ jsxs("div", { className: "text-xs font-medium text-gray-500 dark:text-gray-400 mb-2 flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(QrCode, { className: "h-4 w-4" }),
              "Scan to Chat"
            ] }),
            startChatQr ? /* @__PURE__ */ jsx(
              "img",
              {
                src: startChatQr,
            ...
            ) : /* @__PURE__ */ jsx("div", { className: "h-56 w-56 rounded-lg border border-dashed border-gray-300 dark:border-gray-700 flex items-center justify-center text-xs text-gray-500", children: "QR not available" })
          ] })
        ] }) : /* @__PURE__ */ jsx("div", { className: "rounded-xl border border-amber-300/70 bg-amber-50 dark:bg-amber-900/20 dark:border-amber-800 p-3 text-sm text-amber-800 dark:text-amber-300", children: "Add a valid WhatsApp phone number to generate a customer start conversation link and QR." }) })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6", children: [
        /* @__PURE__ */ jsxs(Card, { className: "border-0 shadow-lg", children: [
          ...
          /* @__PURE__ */ jsxs(CardContent, { className: "space-y-5", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(InputLabel, { value: "Widget Type" }),
              /* @__PURE__ */ jsx(
                "select",
                {
                  ...
                  children: (widget_types.length ? widget_types : ["floater", "qr", "link", "banner"]).map((type) => /* @__PURE__ */ jsxs("option", { value: type, children: [
                    type.toUpperCase(),
                    " Widget"
                  ] }, type))
                }
              ),
              /* @__PURE__ */ jsx(InputError, { message: errors.widget_type, className: "mt-2" })
            ] }),
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx(
                  "select",
                  {
                    ...
                    className: "mt-1 w-full rounded-xl border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-sm",
                    children: isBanner ? /* @__PURE__ */ jsxs(Fragment, { children: [
                      /* @__PURE__ */ jsx("option", { value: "top", children: "Top banner" }),
                      /* @__PURE__ */ jsx("option", { value: "bottom", children: "Bottom banner" })
        ...
        isEmbeddable && /* @__PURE__ */ jsxs(Card, { className: "border-0 shadow-lg", children: [
          /* @__PURE__ */ jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-3", children: [
          /* @__PURE__ */ jsx(Link, { href: route("app.widgets", {}), children: /* @__PURE__ */ jsx(Button, { variant: "secondary", children: "Cancel" }) }),
          /* @__PURE__ */ jsxs(
            Button,
            {
              type: "submit",
