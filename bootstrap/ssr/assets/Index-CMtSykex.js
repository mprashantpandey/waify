  ...
  return /* @__PURE__ */ jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-4", children: [
        ...
        /* @__PURE__ */ jsx(Link, { href: route("app.floaters.create", {}), children: /* @__PURE__ */ jsxs(Button, { className: "bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 shadow-lg shadow-emerald-500/40", children: [
      ...
      widgets.length === 0 ? /* @__PURE__ */ jsx(Card, { className: "border-0 shadow-xl", children: /* @__PURE__ */ jsxs(CardContent, { className: "py-14 text-center", children: [
        ...
        /* @__PURE__ */ jsx(Link, { href: route("app.floaters.create", {}), className: "inline-flex mt-6", children: /* @__PURE__ */ jsx(Button, { className: "bg-emerald-600 hover:bg-emerald-700 text-white", children: "Create Widget" }) })
        ...
        /* @__PURE__ */ jsxs(CardContent, { className: "p-6 space-y-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
            /* @__PURE__ */ jsx(Link, { href: route("app.floaters.edit", { widget: widget.slug || widget.id }), children: /* @__PURE__ */ jsx(Button, { variant: "secondary", children: "Manage" }) }),
            /* @__PURE__ */ jsx(
              Button,
              {
                variant: "secondary",
