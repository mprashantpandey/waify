...
function FAQs({ faqs: initialFaqs }) {
  ...
  return /* @__PURE__ */ jsxs(PublicLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14", children: [
      /* @__PURE__ */ jsx(
        PublicPageHero,
        {
          eyebrow: "FAQs",
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50 dark:from-blue-900/20 dark:via-purple-900/20 dark:to-pink-900/20 rounded-2xl p-6 sm:p-8 text-center border border-blue-200 dark:border-blue-800", children: [
