  ...
  return /* @__PURE__ */ jsxs(PlatformShell, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-gray-600 dark:text-gray-400", children: "Enable or disable modules systemwide. Disabled modules will not be available to any workspace." })
      ] }),
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mt-2", children: [
                    ...
                    /* @__PURE__ */ jsxs("span", { className: "text-xs text-gray-500 dark:text-gray-400", children: [
                      module.workspace_count,
                      " workspace",
                      module.workspace_count !== 1 ? "s" : "",
                      " using"
                    ] })
                  ] })
                ] })
