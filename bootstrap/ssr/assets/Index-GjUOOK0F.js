...
function TagsIndex({
  ...
  const EditTagForm = ({ tag }) => {
    ...
    return /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "grid grid-cols-1 sm:grid-cols-[10rem_4rem_minmax(0,1fr)_auto_auto] items-end gap-2 mt-2 w-full", children: [
      /* @__PURE__ */ jsx(TextInput, { value: data.name, onChange: (e) => setData("name", e.target.value), className: "w-full", required: true }),
      /* @__PURE__ */ jsx("input", { type: "color", value: data.color, onChange: (e) => setData("color", e.target.value), className: "h-9 w-full rounded border" }),
      /* @__PURE__ */ jsx(TextInput, { value: data.description, onChange: (e) => setData("description", e.target.value), className: "w-full", placeholder: "Description" }),
      /* @__PURE__ */ jsx(Button, { type: "submit", size: "sm", className: "w-full sm:w-auto", disabled: processing, children: "Save" }),
      /* @__PURE__ */ jsx(Button, { type: "button", size: "sm", variant: "secondary", className: "w-full sm:w-auto", onClick: () => setEditingId(null), children: "Cancel" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between", children: [
          ...
          /* @__PURE__ */ jsxs(Button, { onClick: () => setShowCreate(!showCreate), className: "w-full sm:w-auto", children: [
      ...
      showCreate && /* @__PURE__ */ jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs("form", { onSubmit: handleCreate, className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[12rem_8rem_minmax(0,1fr)_auto] gap-4 items-end", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 sm:flex gap-2", children: [
            /* @__PURE__ */ jsx(Button, { type: "submit", disabled: creating, className: "w-full sm:w-auto", children: "Create" }),
            /* @__PURE__ */ jsx(Button, { type: "button", variant: "secondary", className: "w-full sm:w-auto", onClick: () => {
              setShowCreate(false);
              resetCreate();
            }, children: "Cancel" })
          ] })
      ...
      tags.length === 0 && !showCreate ? /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(CardContent, { className: "py-16 text-center", children: /* @__PURE__ */ jsx(
      ...
      ) }) }) : /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsx("ul", { className: "divide-y divide-gray-200 dark:divide-gray-700", children: tags.map((tag) => /* @__PURE__ */ jsxs("li", { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between px-6 py-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsx("span", { className: "font-medium text-gray-900 dark:text-gray-100 break-words", children: tag.name }),
        ...
        /* @__PURE__ */ jsx("div", { className: "flex flex-wrap items-stretch sm:items-center gap-2 sm:shrink-0", children: editingId === tag.id ? /* @__PURE__ */ jsx(EditTagForm, { tag }, tag.id) : /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(Button, { variant: "secondary", size: "sm", className: "w-full sm:w-auto", onClick: () => setEditingId(tag.id), children: /* @__PURE__ */ jsx(Pencil, { className: "h-4 w-4" }) }),
          /* @__PURE__ */ jsx(Link, { href: route("app.contacts.index", { tags: [tag.id] }), className: "w-full sm:w-auto", children: /* @__PURE__ */ jsx(Button, { variant: "secondary", size: "sm", className: "w-full sm:w-auto", children: "View contacts" }) }),
          /* @__PURE__ */ jsx(Button, { variant: "secondary", size: "sm", className: "w-full sm:w-auto", onClick: () => handleDelete(tag), children: /* @__PURE__ */ jsx(Trash2, { className: "h-4 w-4" }) })
        ] }) })
      ] }, tag.id)) }) }) })
    ] })
  ] });
