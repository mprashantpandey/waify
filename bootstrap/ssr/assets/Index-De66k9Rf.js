...
import { P as ProviderLogo } from "./ProviderLogo-DiN8H8HE.js";
import { c as cn } from "./utils-B2ZNUmII.js";
import { Code2, Search, Plug, CheckCircle2, Database, RefreshCw, Settings2, Loader2, Unplug, Link2, ExternalLink } from "lucide-react";
...
function IntegrationDrawer({
  ...
  const footer = item.systemManaged ? /* @__PURE__ */ jsx("div", { className: "flex justify-end gap-2", children: /* @__PURE__ */ jsx(Link, { href: route(item.route || "app.whatsapp.connections.index"), children: /* @__PURE__ */ jsxs(Button, { type: "button", variant: "secondary", children: [
  ...
  return /* @__PURE__ */ jsx(Drawer, { open, onClose, title: item.name, description: item.desc, className: "sm:max-w-xl", footer, children: /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
          /* @__PURE__ */ jsx(StatusBadge, { tone: item.connected ? "success" : "muted", dot: true, children: item.connected ? "Connected" : "Not connected" }),
    ...
    visibleFields.length > 0 && /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3", children: [
              ...
              /* @__PURE__ */ jsxs(
                Button,
                {
                  ...
                  children: [
                    integration.connected ? /* @__PURE__ */ jsx(Settings2, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx(Plug, { className: "h-4 w-4" }),
                    integration.connected ? "Manage" : "Configure"
                  ]
                }
              )
            ] }),
