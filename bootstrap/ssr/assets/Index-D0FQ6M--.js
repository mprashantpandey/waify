...
function WhatsAppCallingIndex({
  ...
  const connectionStatus = selectedConnection?.calling_enabled ? "enabled" : selectedConnection?.calling_status || "not_enabled";
            ...
            /* @__PURE__ */ jsx(CardContent, { className: "space-y-5", children: selectedConnection ? /* @__PURE__ */ jsxs("div", { className: "space-y-4 rounded-card border border-gray-100 bg-gray-50 p-4 text-sm dark:border-waify-dark-border dark:bg-waify-dark-surface-2", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2", children: [
                  /* @__PURE__ */ jsx(Badge, { variant: metaCallingReady ? "success" : "warning", children: metaCallingReady ? "Calling enabled" : "Calling disabled" }),
                  /* @__PURE__ */ jsx(Badge, { variant: webhookReady ? "success" : "warning", children: webhookReady ? "Calls webhook ready" : "Calls webhook pending" }),
                  /* @__PURE__ */ jsx(Badge, { variant: routingReady ? "success" : "warning", children: routingReady ? "Routing ready" : "Routing setup needed" })
                ] })
              ] }),
              ...
              canManage && /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2", children: [
                ...
                !metaCallingReady && /* @__PURE__ */ jsx(Button, { type: "button", variant: "success", size: "sm", disabled: actionForm.processing, onClick: () => runConnectionAction("enable"), children: "Enable calling" })
              ] })
