      ...
      /* @__PURE__ */ jsxs(Card, { className: "border-0 shadow-lg", children: [
        ...
        /* @__PURE__ */ jsxs(CardContent, { className: "p-0", children: [
          /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full", children: [
            ...
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-200 dark:divide-gray-800 bg-white dark:bg-gray-900", children: executions.data.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsxs("td", { colSpan: 6, className: "px-6 py-12 text-center", children: [
            ...
            ] }) }) : executions.data.map((execution) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors", children: [
          ...
          executions.meta.last_page > 1 && /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center p-4 border-t border-gray-200 dark:border-gray-700", children: [
            /* @__PURE__ */ jsx(
              Button,
              {
            ...
            /* @__PURE__ */ jsxs("span", { className: "text-sm text-gray-700 dark:text-gray-300", children: [
              "Page ",
              executions.meta.current_page,
              " of ",
              executions.meta.last_page
            ] }),
            /* @__PURE__ */ jsx(
              Button,
              {
