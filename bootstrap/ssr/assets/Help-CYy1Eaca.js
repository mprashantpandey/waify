...
import { HelpCircle, Video, MessageSquare, BookOpen, FileText, Search, Sparkles, ArrowRight, ExternalLink } from "lucide-react";
...
function Help() {
  ...
  const filteredCategories = helpCategories.map((category) => ({
    ...category,
    articles: category.articles.filter((article) => normalizedQuery === "" || category.title.toLowerCase().includes(normalizedQuery) || category.description.toLowerCase().includes(normalizedQuery) || article.toLowerCase().includes(normalizedQuery))
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14", children: [
      /* @__PURE__ */ jsx(
        PublicPageHero,
        {
          ...
          children: /* @__PURE__ */ jsx("div", { className: "max-w-2xl", children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "mb-12", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: filteredCategories.map((category) => {
        ...
        normalizedQuery !== "" && filteredCategories.length === 0 && /* @__PURE__ */ jsxs("div", { className: "mt-6 rounded-xl border border-dashed border-gray-300 dark:border-gray-700 p-6 text-sm text-gray-600 dark:text-gray-400", children: [
          "No help content matched ",
          /* @__PURE__ */ jsxs("span", { className: "font-medium text-gray-900 dark:text-gray-100", children: [
            '"',
            searchQuery,
            '"'
          ] }),
          ". Try a broader keyword or use Contact Support."
        ] })
      ] }),
