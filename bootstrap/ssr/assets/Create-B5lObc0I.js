...
function SegmentsCreate({
  ...
  return /* @__PURE__ */ jsxs(AppShell, { children: [
    /* @__PURE__ */ jsx(Head, { title: "New Segment" }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-gray-100 dark:to-gray-300 bg-clip-text text-transparent", children: "New Segment" })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, children: [
        ...
        /* @__PURE__ */ jsxs(Card, { className: "mt-6", children: [
          /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between", children: [
            /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs(Button, { type: "button", variant: "secondary", size: "sm", className: "w-full sm:w-auto", onClick: addFilter, children: [
              /* @__PURE__ */ jsx(Plus, { className: "h-4 w-4 mr-2" }),
              "Add rule"
            ] })
          ] }) }),
          /* @__PURE__ */ jsx(CardContent, { className: "space-y-4", children: data.filters.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400", children: "No filters. Add a rule to limit which contacts are in this segment, or leave empty to leave the segment empty until you add rules later." }) : data.filters.map((filter, index) => /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-[10rem_9rem_minmax(0,1fr)_auto] items-end gap-2 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50", children: [
            ...
            /* @__PURE__ */ jsx(Button, { type: "button", variant: "secondary", size: "sm", className: "w-full sm:w-auto", onClick: () => removeFilter(index), children: /* @__PURE__ */ jsx(X, { className: "h-4 w-4" }) })
          ] }, index)) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-6 flex flex-col-reverse sm:flex-row gap-3 sm:gap-4", children: [
          /* @__PURE__ */ jsx(Button, { type: "submit", className: "w-full sm:w-auto", disabled: processing, children: "Create segment" }),
          /* @__PURE__ */ jsx(Link, { href: route("app.contacts.segments.index"), className: "w-full sm:w-auto", children: /* @__PURE__ */ jsx(Button, { type: "button", variant: "secondary", className: "w-full sm:w-auto", children: "Cancel" }) })
        ] })
      ] })
    ] })
  ] });
