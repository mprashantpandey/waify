...
function BroadcastsCreate({
  ...
  const availableTemplates = selectedConnection ? templates.filter((t) => {
    if (t.connection_id === null || t.connection_id === void 0 || t.connection_id === "") {
      return true;
    }
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxs(Card, { children: [
          ...
          /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
            ...
            campaignType === "media" && /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(InputLabel, { htmlFor: "media_type", value: "Media Type *" }),
                /* @__PURE__ */ jsxs(
                  "select",
                  {
                    id: "media_type",
                ...
                /* @__PURE__ */ jsx(InputError, { message: errors.media_type, className: "mt-2" })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(InputLabel, { htmlFor: "media_url", value: "Media URL *" }),
                /* @__PURE__ */ jsx(
                  TextInput,
                  {
                    id: "media_url",
                ...
                /* @__PURE__ */ jsx(InputError, { message: errors.media_url, className: "mt-2" })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(InputLabel, { htmlFor: "media_caption", value: "Caption (optional)" }),
                /* @__PURE__ */ jsx(
                  "textarea",
                  {
                    id: "media_caption",
        ...
        /* @__PURE__ */ jsxs(Card, { children: [
          ...
          /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
            ...
            recipientType === "custom" && /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              data.custom_recipients.map((recipient, index) => /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto] gap-2", children: [
                /* @__PURE__ */ jsx(
                  TextInput,
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsx(Button, { type: "button", variant: "secondary", className: "w-full sm:w-auto", onClick: addCustomRecipient, children: "Add Recipient" })
            ] }),
        ...
        /* @__PURE__ */ jsxs(Card, { children: [
          ...
          /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "recipient_sample_size", value: "Recipient Sample Size (0 = all recipients)" }),
              /* @__PURE__ */ jsx(
                TextInput,
                {
              ...
              /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-gray-500 dark:text-gray-400", children: "Use sampling to launch in controlled batches before full scale." }),
              /* @__PURE__ */ jsx(InputError, { message: errors.recipient_sample_size, className: "mt-2" })
            ] }),
            /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-sm text-gray-700 dark:text-gray-300", children: "Dry-run only (preflight + recipient preparation, no outbound send)" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col-reverse sm:flex-row justify-end gap-3 sm:gap-4", children: [
          /* @__PURE__ */ jsx(Link, { href: route("app.broadcasts.index", {}), className: "w-full sm:w-auto", children: /* @__PURE__ */ jsx(Button, { type: "button", variant: "secondary", className: "w-full sm:w-auto", children: "Cancel" }) }),
          /* @__PURE__ */ jsx(Button, { type: "submit", className: "w-full sm:w-auto", disabled: processing, children: data.dry_run ? "Create Dry Run" : data.scheduled_at ? "Schedule Campaign" : "Create Campaign" })
        ] })
      ] })
    ] })
  ] });
