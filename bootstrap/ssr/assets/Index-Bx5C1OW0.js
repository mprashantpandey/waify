...
import { MessageSquare, FileText, BarChart3, Users, TrendingUp } from "lucide-react";
  ...
  return /* @__PURE__ */ jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
        ...
        (usage.ai_credits_used !== void 0 || usage.ai_credits_limit !== void 0) && /* @__PURE__ */ jsxs(Card, { children: [
          /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs(CardTitle, { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(BarChart3, { className: "h-5 w-5 text-amber-500" }),
            "AI credits (this month)"
          ] }) }),
          /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm", children: [
              /* @__PURE__ */ jsx("span", { className: "text-gray-600 dark:text-gray-400", children: "Used" }),
              /* @__PURE__ */ jsxs("span", { className: "font-semibold", children: [
                formatNumber(usage.ai_credits_used ?? 0),
                " / ",
                usage.ai_credits_limit === -1 || usage.ai_credits_limit === void 0 ? "∞" : formatNumber(usage.ai_credits_limit)
              ] })
            ] }),
            (usage.ai_credits_limit ?? 0) > 0 && /* @__PURE__ */ jsx("div", { className: "w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2", children: /* @__PURE__ */ jsx(
              "div",
              {
