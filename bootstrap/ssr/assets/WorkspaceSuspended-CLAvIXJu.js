...
function WorkspaceSuspended({
  workspace
}) {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Workspace Disabled" }),
    /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 flex items-center justify-center p-4", children: /* @__PURE__ */ jsx(Card, { className: "w-full max-w-md border-0 shadow-2xl", children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-12 pb-8 text-center", children: [
      ...
      /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-gray-100 dark:to-gray-300 bg-clip-text text-transparent mb-3", children: "Workspace Disabled" }),
      ...
      workspace.disabled_reason && /* @__PURE__ */ jsx("div", { className: "bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-xl p-4 mb-6 text-left", children: /* @__PURE__ */ jsxs("p", { className: "text-sm text-yellow-800 dark:text-yellow-200", children: [
        /* @__PURE__ */ jsx("strong", { children: "Reason:" }),
        " ",
        workspace.disabled_reason
      ] }) }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400", children: "Please contact support if you believe this is an error." })
    ] }) }) })
  ] });
}
export {
  WorkspaceSuspended as default
};
