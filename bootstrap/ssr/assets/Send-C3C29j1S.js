...
function TemplatesSend({
  ...
  const allVariablesFilled = (template.required_variables.total || 0) === 0 || data.variables.slice(0, template.required_variables.total).every((value) => String(value || "").trim() !== "");
          ...
          /* @__PURE__ */ jsx(CardContent, { className: "p-6", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                ...
                recipientType === "conversation" && /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsxs(
                    "select",
                    {
                  ...
                  conversations.length === 0 && /* @__PURE__ */ jsx("p", { className: "text-xs text-amber-600 dark:text-amber-400", children: "No conversations found. Switch to Contact or Manual Entry." })
                ] }),
                recipientType === "contact" && /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsxs(
                    "select",
                    {
                  ...
                  contacts.length === 0 && /* @__PURE__ */ jsx("p", { className: "text-xs text-amber-600 dark:text-amber-400", children: "No contacts found. Switch to Conversation or Manual Entry." })
                ] }),
            ...
            ["IMAGE", "VIDEO", "DOCUMENT"].includes((template.header_type || "").toUpperCase()) && /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(
                InputLabel,
                {
              ...
              /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-gray-500 dark:text-gray-400", children: "This template requires a media header. Provide a public URL accessible by Meta." }),
              /* @__PURE__ */ jsx(InputError, { message: errors.header_media_url, className: "mt-2" })
            ] }),
            blockedReasons.length > 0 && /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-900/20 p-3", children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold text-amber-900 dark:text-amber-100 mb-1", children: "Complete these before sending:" }),
              /* @__PURE__ */ jsx("ul", { className: "text-xs text-amber-800 dark:text-amber-200 space-y-1", children: blockedReasons.map((reason) => /* @__PURE__ */ jsxs("li", { children: [
                "• ",
                reason
              ] }, reason)) })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-3 sm:gap-4 pt-4 border-t border-gray-200 dark:border-gray-700", children: [
              /* @__PURE__ */ jsx(
                Link,
                {
                  href: route("app.whatsapp.templates.show", {
                  ...
                  children: /* @__PURE__ */ jsx(Button, { type: "button", variant: "secondary", className: "w-full sm:w-auto rounded-xl", children: "Cancel" })
                }
              ),
              /* @__PURE__ */ jsx(
                Button,
