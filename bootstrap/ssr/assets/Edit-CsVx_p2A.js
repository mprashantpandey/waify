...
function TemplatesEdit({
  ...
  return /* @__PURE__ */ jsxs(AppShell, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Edit Template" }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
      ...
      errors.update && /* @__PURE__ */ jsxs(Alert, { variant: "error", className: "border-red-200 dark:border-red-800", children: [
        /* @__PURE__ */ jsx(AlertCircle, { className: "h-5 w-5" }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "font-semibold text-red-800 dark:text-red-200 mb-1", children: "Template Update Error" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-red-600 dark:text-red-400", children: errors.update })
        ] })
      ] }),
          ...
          /* @__PURE__ */ jsxs(Card, { className: "border-0 shadow-lg", children: [
            ...
            /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4 pt-6", children: [
              ...
              ["IMAGE", "VIDEO", "DOCUMENT"].includes(data.header_type) && /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
                ...
                (mediaPreview || data.header_media_url || data.header_media_handle) && /* @__PURE__ */ jsxs("div", { className: "border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-gray-50 dark:bg-gray-800", children: [
                  ...
                  (data.header_type === "VIDEO" || data.header_type === "DOCUMENT") && (mediaPreview || data.header_media_url) && /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600 dark:text-gray-400 break-all", children: mediaPreview || data.header_media_url }),
                  !mediaPreview && !data.header_media_url && data.header_media_handle && /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-600 dark:text-gray-400 break-all", children: [
                    "Meta media sample attached: ",
                    data.header_media_handle
                  ] })
                ] })
              ] })
            ] })
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-between gap-3 pt-6", children: [
          ...
          /* @__PURE__ */ jsx(
            Button,
            {
              ...
              children: processing ? "Updating..." : uploadingMedia ? "Waiting for upload..." : "Update Template"
            }
          )
        ] })
      ] })
